//#region src/lib/error-capture.js
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./assets/server-Cbe1AJKd.js").then((m) => m.default ?? m);
