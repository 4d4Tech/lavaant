import { i as ROLE_META, n as useAuth } from "./auth-BUW1x0A9.js";
import { useEffect } from "react";
import { Link, useNavigate, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { BarChart3, BookOpen, Boxes, CalendarCheck, ClipboardList, FilePlus2, Inbox, LayoutDashboard, LineChart, LogOut, Users } from "lucide-react";
...
//#endregion
//#region src/components/app-shell.jsx
var NAV = {
	inventory: [
		{
			to: "/inventory",
				...
				children: [
					...
					/* @__PURE__ */ jsx("nav", {
						...
						children: items.map((item) => /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(item.icon, { className: "size-4 shrink-0" }), /* @__PURE__ */ jsx("span", {
								className: "truncate",
								children: item.label
							})]
						}, item.to))
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(PortalSwitcher, { current: role }),
							/* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(LogOut, { className: "size-3.5" }), " Sign out"]
							})
						]
					})
				]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("header", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "min-w-0",
							children: [/* @__PURE__ */ jsx(BrandMark, { compact: true }), /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsx("ul", {
					...
					children: items.map((item) => /* @__PURE__ */ jsx("li", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(item.icon, { className: "size-5" }), /* @__PURE__ */ jsx("span", {
								className: "truncate",
								children: item.short
							})]
						})
