import { l as initialInventoryItems, v as usdCents } from "./auth-BUW1x0A9.js";
import { t as AppShell } from "./app-shell-DovqRWXo.js";
import { t as Button } from "./button-CRwLaW16.js";
import { d as Td, f as Th, n as createPurchaseOrder, o as useFirestoreCollection, s as Panel, u as TableWrap } from "./firebase-service-7UuAQbgx.js";
import { useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { CheckCircle2, Minus, Plus, Send, Trash2 } from "lucide-react";
//#region src/routes/inventory.orders.new.jsx?tsr-split=component
var JOBS = [
...
function NewPurchaseOrder() {
	...
	if (submittedPo) return /* @__PURE__ */ jsx(AppShell, {
		role: "inventory",
		title: "Purchase order sent",
		subtitle: `${submittedPo} · ${vendor}`,
		children: /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsxs("div", {
			className: "flex flex-col items-center py-8 text-center",
			children: [
				/* @__PURE__ */ jsx(CheckCircle2, { className: "size-12 text-success" }),
				/* @__PURE__ */ jsxs("h2", {
	...
	return /* @__PURE__ */ jsx(AppShell, {
		...
		actions: /* @__PURE__ */ jsxs(Button, {
			...
			disabled: submitting,
			className: "font-bold",
			children: [/* @__PURE__ */ jsx(Send, { className: "mr-1 size-4" }), submitting ? "Sending…" : "Submit PO"]
		}),
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Panel, {
						...
						children: [
							/* @__PURE__ */ jsx(Field, {
								...
								children: /* @__PURE__ */ jsx("select", {
									...
									className: "field",
									children: vendors.map((v) => /* @__PURE__ */ jsx("option", { children: v }, v))
								})
							}),
							/* @__PURE__ */ jsx(Field, {
								label: "Job / cost code",
								children: /* @__PURE__ */ jsx("select", {
									...
									className: "field",
									children: JOBS.map((j) => /* @__PURE__ */ jsx("option", { children: j }, j))
								})
							}),
							/* @__PURE__ */ jsx(Field, {
								label: "Ship to",
								children: /* @__PURE__ */ jsx("select", {
									...
									className: "field",
									children: SHIP_TO.map((s) => /* @__PURE__ */ jsx("option", { children: s }, s))
								})
							}),
							/* @__PURE__ */ jsx(Field, {
								label: "Need by",
					...
					children: lines.length === 0 ? /* @__PURE__ */ jsx("p", {
						...
						children: lines.map((l) => {
							...
							return /* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(QtyStepper, {
										qty: l.qty,
						...
						children: /* @__PURE__ */ jsx(TableWrap, { children: /* @__PURE__ */ jsxs("table", {
							...
							] }) }), /* @__PURE__ */ jsx("tbody", { children: lines.map((l) => {
								const it = item(l.id);
								return /* @__PURE__ */ jsxs("tr", { children: [
									/* @__PURE__ */ jsxs(Td, { children: [/* @__PURE__ */ jsx("p", {
				...
				children: [/* @__PURE__ */ jsx(Panel, {
					...
					children: /* @__PURE__ */ jsx("ul", {
						className: "space-y-2",
						children: catalogForVendor.map((it) => /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsxs("dl", {
						...
						children: [/* @__PURE__ */ jsx(Send, { className: "mr-1 size-4" }), submitting ? "Sending…" : "Submit purchase order"]
					})]
				})]
			})]
		})
