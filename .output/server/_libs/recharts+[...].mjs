...
import { _ as require_react_dom, y as require_with_selector } from "./@tanstack/react-router+[...].mjs";
...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var children = props.children, width = props.width, height = props.height, viewBox = props.viewBox, className = props.className, style = props.style, title = props.title, desc = props.desc, others = _objectWithoutProperties$24(props, _excluded$24);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
...
var _excluded$23 = ["children", "className"];
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	var children = props.children, className = props.className, others = _objectWithoutProperties$23(props, _excluded$23);
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement(SizeDetectorContainer, _extends$24({}, props, {
		width,
		height,
		ref
	}));
...
function Label(outerProps) {
	...
	if (typeof content === "function") {
		...
		var propsForContent = _objectWithoutProperties$17(propsWithViewBox, _excluded2$9);
...
//#endregion
export { XAxis as a, Line as c, ResponsiveContainer as d, YAxis as i, CartesianGrid as l, BarChart as n, Bar as o, LineChart as r, Area as s, AreaChart as t, Tooltip as u };
