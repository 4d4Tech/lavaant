...
function initializeApp(_options, rawConfig = {}) {
	...
	if (existingApp) if (!deepEqual(options, existingApp.options)) throw ERROR_FACTORY$2.create("duplicate-app", {
		appName: name,
...
registerAnalytics();
//#endregion
export { isIE as A, getExperimentalSetting as C, isCloudWorkstation as D, isBrowserExtension as E, querystring as F, querystringDecode as I, globalthis_default as L, isReactNative as M, isSafari as N, isCloudflareWorker as O, pingServer as P, getDefaultEmulatorHostnameAndPort as S, getUA as T, createMockUserToken as _, _isFirebaseServerApp as a, extractQuerystring as b, initializeApp as c, Logger as d, Component as f, base64Decode as g, FirebaseError as h, _getProvider as i, isMobileCordova as j, isEmpty as k, registerVersion as l, ErrorFactory as m, isSupported as n, _registerComponent as o, Deferred as p, SDK_VERSION as r, getApp as s, getAnalytics as t, LogLevel as u, createSubscribe as v, getModularInstance as w, getDefaultEmulatorHost as x, deepEqual as y };
