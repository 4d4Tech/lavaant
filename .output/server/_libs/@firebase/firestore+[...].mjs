import { D as isCloudWorkstation, L as globalthis_default, N as isSafari, P as pingServer, S as getDefaultEmulatorHostnameAndPort, T as getUA, _ as createMockUserToken, a as _isFirebaseServerApp, d as Logger, f as Component, h as FirebaseError, i as _getProvider, l as registerVersion, o as _registerComponent, r as SDK_VERSION, s as getApp, u as LogLevel, w as getModularInstance, y as deepEqual } from "./analytics+[...].mjs";
...
//#endregion
//#region node_modules/@firebase/firestore/dist/common-DugxmK6F.esm.js
/**
* @license
...
* limitations under the License.
*/
var Se = new Logger("@firebase/firestore");
...
function __PRIVATE_logDebug(e, ...t) {
	if (Se.logLevel <= LogLevel.DEBUG) {
		...
		Se.debug(`Firestore (${ve}): ${e}`, ...n);
	}
}
function __PRIVATE_logError(e, ...t) {
	if (Se.logLevel <= LogLevel.ERROR) {
		const n = t.map(__PRIVATE_argToString);
		Se.error(`Firestore (${ve}): ${e}`, ...n);
	}
}
/**
* @internal
*/ function __PRIVATE_logWarn(e, ...t) {
	if (Se.logLevel <= LogLevel.WARN) {
		const n = t.map(__PRIVATE_argToString);
		Se.warn(`Firestore (${ve}): ${e}`, ...n);
	}
}
/**
...
function __PRIVATE__fail(e, t, n) {
	let r = `FIRESTORE (${ve}) INTERNAL ASSERTION FAILED: ${t} (ID: ${e.toString(16)})`;
	if (void 0 !== n) try {
...
/** An error returned by a Firestore operation. */ var s = class extends FirebaseError {
	/** @hideconstructor */
	constructor(e, t) {
...
*/ function __PRIVATE_validateNonEmptyArgument(e, t, n) {
	if (!n) throw new s(aa.INVALID_ARGUMENT, `Function ${e}() cannot be called with an empty ${t}.`);
}
/**
* Validates that two boolean options are not set at the same time.
* @internal
*/ function __PRIVATE_validateIsNotUsedTogether(e, t, n, r) {
	if (true === t && true === r) throw new s(aa.INVALID_ARGUMENT, `${e} and ${n} cannot be used together.`);
}
/**
* Validates that `path` refers to a document (indicated by the fact it contains
* an even numbers of segments).
*/ function __PRIVATE_validateDocumentPath(e) {
	if (!DocumentKey.isDocumentKey(e)) throw new s(aa.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${e} has ${e.length}.`);
}
/**
* Validates that `path` refers to a collection (indicated by the fact it
* contains an odd numbers of segments).
*/ function __PRIVATE_validateCollectionPath(e) {
	if (DocumentKey.isDocumentKey(e)) throw new s(aa.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${e} has ${e.length}.`);
}
/**
...
function ra(e, t) {
	if ("_delegate" in e && (e = e._delegate), !(e instanceof t)) {
		if (t.name === e.constructor.name) throw new s(aa.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
		{
			const n = __PRIVATE_valueDescription(e);
			throw new s(aa.INVALID_ARGUMENT, `Expected type '${t.name}', but it was: ${n}`);
		}
	}
	return e;
}
...
*/ function __PRIVATE_validateJSON(e, t) {
	if (!p(e)) throw new s(aa.INVALID_ARGUMENT, "JSON must be an object");
	let n;
	...
	if (n) throw new s(aa.INVALID_ARGUMENT, n);
	return true;
}
/**
* @license
...
var Timestamp = class Timestamp {
	...
	*/ constructor(e, t) {
		if (this.seconds = e, this.nanoseconds = t, t < 0) throw new s(aa.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + t);
		if (t >= 1e9) throw new s(aa.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + t);
		if (e < Me) throw new s(aa.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
		if (e >= 253402300800) throw new s(aa.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
	}
	/**
...
*   localWriteTime.
*/ var Be = "server_timestamp";
var Ue = "__type__";
var ke = "__previous_value__";
var qe = "__local_write_time__";
function __PRIVATE_isServerTimestamp(e) {
	return (e?.mapValue?.fields || {})[Ue]?.stringValue === Be;
}
/**
...
function __PRIVATE_databaseIdFromApp(e, t) {
	if (!Object.prototype.hasOwnProperty.apply(e.options, ["projectId"])) throw new s(aa.INVALID_ARGUMENT, "\"projectId\" not provided in firebase.initializeApp.");
...
*/ var We = "__type__";
var Qe = "__max__";
var Ge = { mapValue: { fields: { __type__: { stringValue: Qe } } } };
var ze = "__vector__";
var je = "value";
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function __PRIVATE_valueEquals$1(e, t, n) {
	...
	switch (r) {
		...
		case 2: return function __PRIVATE_numberEquals(e, t, n) {
			...
			if (r === i) return !!n?.i || __PRIVATE_isNegativeZero(r) === __PRIVATE_isNegativeZero(i);
			return !!(void 0 === n || n.o) && isNaN(r) && isNaN(i);
		}(e, t, n);
...
/** Returns true if `value` is a VetorValue. */ function __PRIVATE_isVectorValue(e) {
	return (e?.mapValue?.fields || {})[We]?.stringValue === ze;
}
...
/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function __PRIVATE_isMaxValue(e) {
	return (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === Qe;
}
/**
* @license
* Copyright 2017 Google LLC
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e, t) {
		...
		const n = __PRIVATE_computeTransformOperationBaseValue(e, t), r = asNumber(n) + asNumber(e.l);
		return isInteger(n) && isInteger(e.l) ? __PRIVATE_toInteger(r) : __PRIVATE_toDouble(e.serializer, r);
...
function __PRIVATE_applyNumericTransformOperationToLocalView(e, t, n) {
	if (!R(t)) return e.l;
	const r = n(asNumber(t), asNumber(e.l));
	return isInteger(t) && isInteger(e.l) ? __PRIVATE_toInteger(r) : __PRIVATE_toDouble(e.serializer, r);
}
function asNumber(e) {
...
var CompositeFilter = class CompositeFilter extends Filter {
	...
	*/ static create(e, t) {
	...
	getFlattenedFilters() {
		return null !== this.P || (this.P = this.filters.reduce(((e, t) => e.concat(t.getFlattenedFilters())), [])), this.P;
	}
	getFilters() {
...
var __PRIVATE_QueryImpl = class {
	...
	*/
	constructor(e, t = null, n = [], r = [], i = null, s = "F", _ = null, o = null) {
		this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r, this.limit = i, this.limitType = s, this.startAt = _, this.endAt = o, this.I = null, this.A = null, this.V = null, this.startAt, this.endAt;
	}
};
...
*/ function __PRIVATE_queryNormalizedOrderBy(e) {
	...
	if (null === t.I) {
		...
		for (const n of t.explicitOrderBy) t.I.push(n), e.add(n.field.canonicalString());
		...
		(function __PRIVATE_getInequalityFilterFields(e) {
			...
			e.has(r.canonicalString()) || r.isKeyField() || t.I.push(new OrderBy(r, n));
		})), e.has(Oe.keyField().canonicalString()) || t.I.push(new OrderBy(Oe.keyField(), n));
	}
	return t.I;
}
/**
...
function __PRIVATE_isPermanentError(e) {
	switch (e) {
		...
		case aa.INTERNAL:
		case aa.UNAVAILABLE:
		case aa.UNAUTHENTICATED: return false;
...
function __PRIVATE_mapCodeFromRpcCode(e) {
	if (void 0 === e) return __PRIVATE_logError("GRPC error has no .code"), aa.UNKNOWN;
	switch (e) {
		case et.OK: return aa.OK;
		case et.CANCELLED: return aa.CANCELLED;
		case et.UNKNOWN: return aa.UNKNOWN;
		case et.DEADLINE_EXCEEDED: return aa.DEADLINE_EXCEEDED;
		case et.RESOURCE_EXHAUSTED: return aa.RESOURCE_EXHAUSTED;
		case et.INTERNAL: return aa.INTERNAL;
		case et.UNAVAILABLE: return aa.UNAVAILABLE;
		case et.UNAUTHENTICATED: return aa.UNAUTHENTICATED;
		case et.INVALID_ARGUMENT: return aa.INVALID_ARGUMENT;
		case et.NOT_FOUND: return aa.NOT_FOUND;
		case et.ALREADY_EXISTS: return aa.ALREADY_EXISTS;
		case et.PERMISSION_DENIED: return aa.PERMISSION_DENIED;
		case et.FAILED_PRECONDITION: return aa.FAILED_PRECONDITION;
		case et.ABORTED: return aa.ABORTED;
		case et.OUT_OF_RANGE: return aa.OUT_OF_RANGE;
		case et.UNIMPLEMENTED: return aa.UNIMPLEMENTED;
		case et.DATA_LOSS: return aa.DATA_LOSS;
...
var BloomFilter = class BloomFilter {
	constructor(e, t, n) {
		...
		this.m = 8 * e.length - t, this.p = Integer.fromNumber(this.m);
	}
	v(e, t, n) {
		let r = e.add(t.multiply(Integer.fromNumber(n)));
		return 1 === r.compare(at) && (r = new Integer([r.getBits(0), r.getBits(1)], 0)), r.modulo(this.p).toNumber();
	}
	S(e) {
		return !!(this.bitmap[Math.floor(e / 8)] & 1 << e % 8);
	}
	mightContain(e) {
		if (0 === this.m) return false;
		const [n, r] = __PRIVATE_get64BitUints(__PRIVATE_getMd5HashValue(e));
		for (let e = 0; e < this.hashCount; e++) {
			const t = this.v(n, r, e);
			if (!this.S(t)) return false;
		}
		return true;
	}
...
/** Tracks the internal state of a Watch target. */ var __PRIVATE_TargetState = class {
	...
	*/
	constructor(e) {
		this.targetId = e, this.M = 0, this.N = __PRIVATE_snapshotChangesMap(), this.L = ByteString.EMPTY_BYTE_STRING, this.B = false, this.U = true;
	}
	/**
	...
	*/ $(e) {
		e.approximateByteSize() > 0 && (this.U = true, this.L = e);
	}
	/**
	...
	*/ K() {
		...
		})), new TargetChange(this.L, this.B, e, t, n);
	}
	/**
	* Resets the document changes and sets `hasPendingChanges` to false.
	*/ W() {
		this.U = false, this.N = __PRIVATE_snapshotChangesMap();
	}
	G(e, t) {
		this.U = true, this.N = this.N.insert(e, t);
	}
	j(e) {
		this.U = true, this.N = this.N.remove(e);
	}
	H() {
		this.M += 1;
	}
	J() {
		this.M -= 1, __PRIVATE_hardAssert(this.M >= 0, 3241, {
			M: this.M,
...
*/ var __PRIVATE_WatchChangeAggregator = class {
	constructor(e) {
		this.Z = e, this.X = /* @__PURE__ */ new Map(), this.ee = __PRIVATE_mutableDocumentMap(), this.te = __PRIVATE_documentTargetMap(), this.ne = __PRIVATE_mutableDocumentMap(), this.re = __PRIVATE_documentTargetMap(), this.ie = new SortedMap(__PRIVATE_primitiveComparator);
	}
	/**
	...
	*/ se(e) {
	...
	/** Processes and adds the WatchTargetChange to the current set of changes. */ ae(e) {
	...
	*/ Ve(e, t) {
		...
		let r = 0;
		return n.forEach(((n) => {
			const i = this.Z.Ae(), s = `projects/${i.projectId}/databases/${i.database}/documents/${n.path.canonicalString()}`;
			e.mightContain(s) || (this.oe(t, n, null), r++);
		})), r;
	}
	/**
	...
	*/ de(e) {
		...
		this.X.forEach(((n, r) => {
			...
			if (i) {
				if (n.current && this.le(i.target)) {
					...
					this.fe(n).has(r) || this.me(r, n) || this.oe(r, n, MutableDocument.newNoDocument(n, e));
				}
				n.q && (t.set(r, n.K()), n.W());
			}
		}));
		...
		const r = new RemoteEvent(e, t, this.ie, this.ee, this.ne, n);
		return this.ee = __PRIVATE_mutableDocumentMap(), this.te = __PRIVATE_documentTargetMap(), this.ne = __PRIVATE_mutableDocumentMap(), this.re = __PRIVATE_documentTargetMap(), this.ie = new SortedMap(__PRIVATE_primitiveComparator), r;
	}
	/**
	...
	*/
	_e(e, t) {
		...
		if (!n || !this.ue(e)) return void __PRIVATE_logDebug(ut, `addDocumentToTarget received document for unknown inactive target (${e})`);
		const r = this.me(e, t.key) ? 2 : 0;
		n.G(t.key, r), __PRIVATE_targetIsPipelineTarget(this.he(e).target) && "exact" !== this.he(e).target.getPipelineFlavor() ? this.ne = this.ne.insert(t.key, t) : this.ee = this.ee.insert(t.key, t), this.te = this.te.insert(t.key, this.fe(t.key).add(e)), this.re = this.re.insert(t.key, this.pe(t.key).add(e));
	}
	/**
	...
	*/
	oe(e, t, n) {
		const r = this.X.get(e);
		r && this.ue(e) ? (this.me(e, t) ? r.G(t, 1) : r.j(t), this.re = this.re.insert(t, this.pe(t).delete(e)), this.re = this.re.insert(t, this.pe(t).add(e)), n && (__PRIVATE_targetIsPipelineTarget(this.he(e).target) && "exact" !== this.he(e).target.getPipelineFlavor() ? this.ne = this.ne.insert(t, n) : this.ee = this.ee.insert(t, n))) : __PRIVATE_logDebug(ut, `removeDocumentFromTarget received document for unknown or inactive target (${e})`);
	}
	removeTarget(e) {
		this.X.delete(e);
	}
	...
	*/ H(e) {
		let t = this.X.get(e);
		t || (__PRIVATE_logDebug(ut, `recordPendingTargetRequest set up tracking for target ID ${e}`), t = new __PRIVATE_TargetState(e), this.X.set(e, t)), t.H();
	}
	pe(e) {
		let t = this.re.get(e);
		return t || (t = new SortedSet(__PRIVATE_primitiveComparator), this.re = this.re.insert(e, t)), t;
	}
	fe(e) {
		let t = this.te.get(e);
		return t || (t = new SortedSet(__PRIVATE_primitiveComparator), this.te = this.te.insert(e, t)), t;
	}
	/**
	...
	*/ he(e) {
		const t = this.X.get(e);
		return void 0 === t || t.k ? null : this.Z.ge(e);
	}
	/**
	...
	* from all documents).
	*/ ce(e) {
		this.X.set(e, new __PRIVATE_TargetState(e));
...
function fromName(e, t) {
	...
	if (n.get(1) !== e.databaseId.projectId) throw new s(aa.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + e.databaseId.projectId);
	if (n.get(3) !== e.databaseId.database) throw new s(aa.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + e.databaseId.database);
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		}(t.targetChange.targetChangeType || "NO_CHANGE"), i = t.targetChange.targetIds || [], _ = function __PRIVATE_fromBytes(e, t) {
		...
		n = new __PRIVATE_WatchTargetChange(r, i, _, o && function __PRIVATE_fromRpcStatus(e) {
			return new s(void 0 === e.code ? aa.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e.code), e.message || "");
		}(o) || null);
	} else if ("documentChange" in t) {
		t.documentChange;
		const r = t.documentChange;
		r.document, r.document.name, r.document.updateTime;
		const i = fromName(e, r.document.name), s = __PRIVATE_fromVersion(r.document.updateTime), _ = r.document.createTime ? __PRIVATE_fromVersion(r.document.createTime) : SnapshotVersion.min(), o = new ObjectValue({ mapValue: { fields: r.document.fields } }), a = MutableDocument.newFoundDocument(i, s, _, o);
		n = new __PRIVATE_DocumentWatchChange(r.targetIds || [], r.removedTargetIds || [], a.key, a);
	} else if ("documentDelete" in t) {
		t.documentDelete;
		const r = t.documentDelete;
		r.document;
		const i = fromName(e, r.document), s = r.readTime ? __PRIVATE_fromVersion(r.readTime) : SnapshotVersion.min(), _ = MutableDocument.newNoDocument(i, s);
		n = new __PRIVATE_DocumentWatchChange([], r.removedTargetIds || [], _.key, _);
		...
		if (!("filter" in t)) return l(11601, { ye: t });
		{
			t.filter;
			const e = t.filter;
			e.targetId;
			const { count: r = 0, unchangedNames: i } = e, s = new ExistenceFilter(r, i), _ = e.targetId;
			n = new __PRIVATE_ExistenceFilterChange(_, s);
		}
	}
	return n;
}
function toMutation(e, t) {
	...
	if (t instanceof __PRIVATE_SetMutation) n = { update: __PRIVATE_toMutationDocument(e, t.key, t.value) };
		...
		if (!(t instanceof __PRIVATE_VerifyMutation)) return l(16599, { we: t.type });
...
*/ var Bytes = class Bytes {
	...
	*/ static fromBase64String(e) {
		try {
			...
			throw new s(aa.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
		}
	}
	/**
...
var FieldPath = class {
	...
	*/
	constructor(...e) {
		for (let t = 0; t < e.length; ++t) if (0 === e[t].length) throw new s(aa.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
		this._internalPath = new Oe(e);
	}
	/**
...
*/ var GeoPoint = class GeoPoint {
	...
	*/
	constructor(e, t) {
		if (!isFinite(e) || e < -90 || e > 90) throw new s(aa.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + e);
		if (!isFinite(t) || t < -180 || t > 180) throw new s(aa.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + t);
...
var __PRIVATE_FirebaseAuthCredentialsProvider = class {
	constructor(e) {
		this.Se = e, this.currentUser = User.UNAUTHENTICATED, this.De = 0, this.forceRefresh = false, this.auth = null;
	}
	start(e, t) {
		__PRIVATE_hardAssert(void 0 === this.xe, 42304);
		let n = this.De;
		const __PRIVATE_guardedChangeListener = (e) => this.De !== n ? (n = this.De, t(e)) : Promise.resolve();
		let r = new __PRIVATE_Deferred();
		this.xe = () => {
			this.De++, this.currentUser = this.Ce(), r.resolve(), r = new __PRIVATE_Deferred(), e.enqueueRetryable((() => __PRIVATE_guardedChangeListener(this.currentUser)));
		};
		const __PRIVATE_awaitNextToken = () => {
			...
			__PRIVATE_logDebug("FirebaseAuthCredentialsProvider", "Auth detected"), this.auth = e, this.xe && (this.auth.addAuthTokenListener(this.xe), __PRIVATE_awaitNextToken());
		};
		this.Se.onInit(((e) => __PRIVATE_registerAuth(e))), setTimeout((() => {
			if (!this.auth) {
				const e = this.Se.getImmediate({ optional: true });
	...
	getToken() {
		...
		return this.forceRefresh = false, this.auth ? this.auth.getToken(t).then(((t) => this.De !== e ? (__PRIVATE_logDebug("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : t ? (__PRIVATE_hardAssert("string" == typeof t.accessToken, 31837, { Fe: t }), new __PRIVATE_OAuthToken(t.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
	}
	invalidateToken() {
	...
	Ce() {
		...
		return __PRIVATE_hardAssert(null === e || "string" == typeof e, 2055, { Oe: e }), new User(e);
	}
};
var __PRIVATE_FirstPartyToken = class {
	constructor(e, t, n) {
		this.Me = e, this.Ne = t, this.Le = n, this.type = "FirstParty", this.user = User.FIRST_PARTY, this.Be = /* @__PURE__ */ new Map();
	}
	/**
...
var __PRIVATE_FirstPartyAuthCredentialsProvider = class {
	...
	getToken() {
		return Promise.resolve(new __PRIVATE_FirstPartyToken(this.Me, this.Ne, this.Le));
	}
	start(e, t) {
...
var __PRIVATE_FirebaseAppCheckTokenProvider = class {
	constructor(e, t) {
		this.ke = t, this.forceRefresh = false, this.appCheck = null, this.qe = null, this.$e = null, _isFirebaseServerApp(e) && e.settings.appCheckToken && (this.$e = e.settings.appCheckToken);
	}
	start(e, t) {
		__PRIVATE_hardAssert(void 0 === this.xe, 3512);
		const onTokenChanged = (e) => {
			...
			const n = e.token !== this.qe;
			return this.qe = e.token, __PRIVATE_logDebug("FirebaseAppCheckTokenProvider", `Received ${n ? "new" : "existing"} token.`), n ? t(e.token) : Promise.resolve();
		};
		this.xe = (t) => {
			e.enqueueRetryable((() => onTokenChanged(t)));
		};
		const __PRIVATE_registerAppCheck = (e) => {
			__PRIVATE_logDebug("FirebaseAppCheckTokenProvider", "AppCheck detected"), this.appCheck = e, this.xe && this.appCheck.addTokenListener(this.xe);
		};
		this.ke.onInit(((e) => __PRIVATE_registerAppCheck(e))), setTimeout((() => {
			if (!this.appCheck) {
				const e = this.ke.getImmediate({ optional: true });
				e ? __PRIVATE_registerAppCheck(e) : __PRIVATE_logDebug("FirebaseAppCheckTokenProvider", "AppCheck not yet detected");
			}
		}), 0);
	}
	getToken() {
		if (this.$e) return Promise.resolve(new AppCheckToken(this.$e));
		const e = this.forceRefresh;
		return this.forceRefresh = false, this.appCheck ? this.appCheck.getToken(e).then(((e) => e ? (__PRIVATE_hardAssert("string" == typeof e.token, 44558, { tokenResult: e }), this.qe = e.token, new AppCheckToken(e.token)) : null)) : Promise.resolve(null);
	}
	invalidateToken() {
		this.forceRefresh = true;
	}
...
*/ var __PRIVATE_BrowserConnectivityMonitor = class {
	constructor() {
		this.We = () => this.Qe(), this.Ge = () => this.ze(), this.je = [], this.He();
	}
	Ke(e) {
		this.je.push(e);
	}
	shutdown() {
		window.removeEventListener("online", this.We), window.removeEventListener("offline", this.Ge);
	}
	He() {
		window.addEventListener("online", this.We), window.addEventListener("offline", this.Ge);
	}
	Qe() {
...
var __PRIVATE_RestConnection = class {
	...
	constructor(e) {
		...
		this.Ze = t + "://" + e.host, this.Xe = `projects/${n}/databases/${r}`, this.et = this.databaseId.database === $e ? `project_id=${n}` : `project_id=${n}&database_id=${r}`;
	}
	tt(e, t, n, r, i) {
		const s = __PRIVATE_generateUniqueDebugId(), _ = this.nt(e, t.toUriEncodedString());
		...
		return this.it(e, _, o, n, u).then(((t) => (__PRIVATE_logDebug(Pt, `Received RPC '${e}' ${s}: `, t), t)), ((t) => {
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	...
	*/ static ft() {
		if (!__PRIVATE_WebChannelConnection.gt) __PRIVATE_unguardedEventListen(getStatEventTarget(), Event.STAT_EVENT, ((e) => {
			e.stat === Stat.PROXY ? __PRIVATE_logDebug(It, "STAT_EVENT: detected buffering proxy") : e.stat === Stat.NOPROXY && __PRIVATE_logDebug(It, "STAT_EVENT: detected no buffering proxy");
		})), __PRIVATE_WebChannelConnection.gt = true;
	}
	it(e, t, n, r, i) {
				...
				try {
					switch (a.getLastErrorCode()) {
						case ErrorCode.NO_ERROR:
							...
							__PRIVATE_logDebug(It, `XHR for RPC '${e}' ${_} received:`, JSON.stringify(t)), i(t);
							break;
						case ErrorCode.TIMEOUT:
							__PRIVATE_logDebug(It, `RPC '${e}' ${_} timed out`), o(new s(aa.DEADLINE_EXCEEDED, "Request time out"));
							break;
						case ErrorCode.HTTP_ERROR:
							const n = a.getStatus();
							if (__PRIVATE_logDebug(It, `RPC '${e}' ${_} failed with status:`, n, "response text:", a.getResponseText()), n > 0) {
								let e = a.getResponseJson();
								Array.isArray(e) && (e = e[0]);
								const t = e?.error;
								if (t && t.status && t.message) o(new s(function __PRIVATE_mapCodeFromHttpResponseErrorStatus(e) {
									const t = e.toLowerCase().replace(/_/g, "-");
									return Object.values(aa).indexOf(t) >= 0 ? t : aa.UNKNOWN;
								}(t.status), t.message));
								else o(new s(aa.UNKNOWN, "Server responded with status " + a.getStatus()));
							} else o(new s(aa.UNAVAILABLE, "Connection failed."));
							break;
						default: l(9055, {
							yt: e,
							streamId: _,
							wt: a.getLastErrorCode(),
							bt: a.getLastError()
						});
					}
				} finally {
					__PRIVATE_logDebug(It, `RPC '${e}' ${_} completed.`);
				}
			}));
			const u = JSON.stringify(r);
			__PRIVATE_logDebug(It, `RPC '${e}' ${_} sending request:`, r), a.send(t, "POST", u, n, 15);
		}));
	}
	vt(e, t, n) {
		...
		void 0 !== a && (o.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (o.useFetchStreams = true), this.rt(o.initMessageHeaders, t, n), o.encodeInitMessageHeaders = true;
		const u = i.join("");
		__PRIVATE_logDebug(It, `Creating RPC '${e}' stream ${r}: ${u}`, o);
		const c = _.createWebChannel(u, o);
		this.St(c);
		let l = false, E = false;
		const h = new __PRIVATE_StreamBridge({
			_t: (t) => {
				E ? __PRIVATE_logDebug(It, `Not sending because RPC '${e}' stream ${r} is closed:`, t) : (l || (__PRIVATE_logDebug(It, `Opening RPC '${e}' stream ${r} transport.`), c.open(), l = true), __PRIVATE_logDebug(It, `RPC '${e}' stream ${r} sending:`, t), c.send(t));
			},
			ot: () => c.close()
		});
		return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, (() => {
			E || (__PRIVATE_logDebug(It, `RPC '${e}' stream ${r} transport opened.`), h.Rt());
		})), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.CLOSE, (() => {
			E || (E = !0, __PRIVATE_logDebug(It, `RPC '${e}' stream ${r} transport closed`), h.At(), this.Dt(c));
		})), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, ((t) => {
			E || (E = !0, __PRIVATE_logWarn(It, `RPC '${e}' stream ${r} transport errored. Name:`, t.name, "Message:", t.message), h.At(new s(aa.UNAVAILABLE, "The operation could not be completed")));
		})), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.MESSAGE, ((t) => {
			if (!E) {
				const n = t.data[0];
				__PRIVATE_hardAssert(!!n, 16349);
				const i = n, _ = i?.error || i[0]?.error;
				if (_) {
					__PRIVATE_logDebug(It, `RPC '${e}' stream ${r} received error:`, _);
					const t = _.status;
					let n = function __PRIVATE_mapCodeFromRpcStatus(e) {
						const t = et[e];
						if (void 0 !== t) return __PRIVATE_mapCodeFromRpcCode(t);
					}(t), i = _.message;
					"NOT_FOUND" === t && i.includes("database") && i.includes("does not exist") && i.includes(this.databaseId.database) && __PRIVATE_logWarn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`), void 0 === n && (n = aa.INTERNAL, i = "Unknown error status: " + t + " with message " + _.message), E = !0, h.At(new s(n, i)), c.close();
				} else __PRIVATE_logDebug(It, `RPC '${e}' stream ${r} received:`, n), h.Vt(n);
			}
		})), __PRIVATE_WebChannelConnection.ft(), setTimeout((() => {
			h.It();
		}), 0), h;
	}
	/**
...
/** Return the Platform-specific connectivity monitor. */ __PRIVATE_WebChannelConnection.gt = false;
/**
...
var __PRIVATE_ExponentialBackoff = class {
	...
	*/ Ut(e) {
		this.cancel();
		const t = Math.floor(this.Mt + this.kt()), n = Math.max(0, Date.now() - this.Lt), r = Math.max(0, t - n);
		r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.Mt} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Nt = this.xt.enqueueAfterDelay(this.timerId, r, (() => (this.Lt = Date.now(), e()))), this.Mt *= this.Ft, this.Mt < this.Ct && (this.Mt = this.Ct), this.Mt > this.Ot && (this.Mt = this.Ot);
	}
	qt() {
		null !== this.Nt && (this.Nt.skipDelay(), this.Nt = null);
	}
	cancel() {
		null !== this.Nt && (this.Nt.cancel(), this.Nt = null);
	}
	/** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ kt() {
...
var __PRIVATE_PersistentStream = class {
	constructor(e, t, n, r, i, s, _, o) {
		this.xt = e, this.$t = n, this.Kt = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = _, this.listener = o, this.state = 0, this.Wt = 0, this.Qt = null, this.Gt = null, this.stream = null, this.zt = 0, this.jt = new __PRIVATE_ExponentialBackoff(e, t);
	}
	/**
	...
	* outbound requests.
	*/ Ht() {
		return 1 === this.state || 5 === this.state || this.Jt();
	}
	/**
	...
	*/ start() {
		this.zt = 0, 4 !== this.state ? this.auth() : this.Yt();
	}
	/**
	...
	*/ Xt() {
		this.Jt() && null === this.Qt && (this.Qt = this.xt.enqueueAfterDelay(this.$t, 6e4, (() => this.en())));
	}
	/** Sends a message to the underlying stream. */ tn(e) {
		this.nn(), this.stream.send(e);
	}
	/** Called by the idle timer when the stream should close due to inactivity. */ async en() {
		if (this.Jt()) return this.close(0);
	}
	/** Marks the stream as active again. */ nn() {
		this.Qt && (this.Qt.cancel(), this.Qt = null);
	}
	/** Cancels the health check delayed operation. */ rn() {
	...
	*/ async close(e, t) {
		this.nn(), this.rn(), this.jt.cancel(), this.Wt++, 4 !== e ? this.jt.reset() : t && t.code === aa.RESOURCE_EXHAUSTED ? (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.jt.Bt()) : t && t.code === aa.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.sn(), this.stream.close(), this.stream = null), this.state = e, await this.listener.ht(t);
	}
	/**
	...
	*/ sn() {}
	auth() {
		this.state = 1;
		const e = this._n(this.Wt), t = this.Wt;
		Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then((([e, n]) => {
			this.Wt === t && this.an(e, n);
		}), ((t) => {
			e((() => {
				const e = new s(aa.UNKNOWN, "Fetching auth token failed: " + t.message);
				return this.un(e);
			}));
		}));
	}
	an(e, t) {
		const n = this._n(this.Wt);
		this.stream = this.cn(e, t), this.stream.ut((() => {
			...
			n((() => 1 == ++this.zt ? this.En(e) : this.onNext(e)));
		}));
	}
	Yt() {
	...
	*/ _n(e) {
		return (t) => {
			this.xt.enqueueAndForget((() => this.Wt === e ? t() : (__PRIVATE_logDebug(At, "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve())));
		};
	}
};
/**
...
*/ var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
	...
	*/ Tn(e) {
		...
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e, t) {
			let n;
			const r = t.target;
			if (n = __PRIVATE_targetIsPipelineTarget(r) ? { pipelineQuery: __PRIVATE_toPipelineTarget(e, r) } : __PRIVATE_targetIsDocumentTarget(r) ? { documents: __PRIVATE_toDocumentsTarget(e, r) } : { query: __PRIVATE_toQueryTarget(e, r).be }, n.targetId = t.targetId, t.resumeToken.approximateByteSize() > 0) {
	...
	*/ Pn(e) {
		const t = {};
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.removeTarget = e, this.tn(t);
	}
};
/**
...
*/ var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
	...
	*/ get Rn() {
	...
	En(e) {
		return __PRIVATE_hardAssert(!!e.streamToken, 31322), this.lastStreamToken = e.streamToken, __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length, 55816), this.listener.An();
	}
	onNext(e) {
		__PRIVATE_hardAssert(!!e.streamToken, 12678), this.lastStreamToken = e.streamToken, this.jt.reset();
	...
	*/ dn() {
		const e = {};
		e.database = __PRIVATE_getEncodedDatabaseId(this.serializer), this.tn(e);
	}
	/** Sends a group of mutations to the Firestore backend to apply. */ In(e) {
		const t = {
...
*/ var __PRIVATE_DatastoreImpl = class extends Datastore {
	constructor(e, t, n, r) {
		super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = n, this.serializer = r, this.fn = false;
	}
	mn() {
		if (this.fn) throw new s(aa.FAILED_PRECONDITION, "The client has already been terminated.");
	}
	/** Invokes the provided RPC with auth and AppCheck tokens. */ tt(e, t, n, r) {
		return this.mn(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([i, s]) => this.connection.tt(e, __PRIVATE_toResourcePath(t, n), r, i, s))).catch(((e) => {
			throw "FirebaseError" === e.name ? (e.code === aa.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e) : new s(aa.UNKNOWN, e.toString());
		}));
	}
	/** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ st(e, t, n, r, i) {
		return this.mn(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([s, _]) => this.connection.st(e, __PRIVATE_toResourcePath(t, n), r, s, _, i))).catch(((e) => {
			throw "FirebaseError" === e.name ? (e.code === aa.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e) : new s(aa.UNKNOWN, e.toString());
		}));
	}
	terminate() {
		this.fn = true, this.connection.terminate();
	}
};
...
*/ async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
	if (e.code !== aa.FAILED_PRECONDITION || e.message !== pt) throw e;
...
*/ var __PRIVATE_RollingSequenceNumberBuffer = class {
	constructor(e) {
		this.Jn = e, this.buffer = new SortedSet(__PRIVATE_bufferEntryComparator), this.Yn = 0;
	}
	Zn() {
		return ++this.Yn;
	}
...
*/ var __PRIVATE_LruScheduler = class {
	...
	start() {
		-1 !== this.garbageCollector.params.cacheSizeCollectionThreshold && this.tr(6e4);
	}
	stop() {
	...
	tr(e) {
		__PRIVATE_logDebug(wt, `Garbage collection scheduled in ${e}ms`), this.er = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, (async () => {
			this.er = null;
			try {
...
*/ var __PRIVATE_LruGarbageCollectorImpl = class {
	...
	nthSequenceNumber(e, t) {
		if (0 === t) return PersistencePromise.resolve(__PRIVATE_ListenSequence.yn);
...
* limitations under the License.
*/
var vt = "firestore.googleapis.com";
var St = true;
/**
...
var FirestoreSettingsImpl = class {
	constructor(e) {
		if (void 0 === e.host) {
			if (void 0 !== e.ssl) throw new s(aa.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
			this.host = vt, this.ssl = St;
		} else this.host = e.host, this.ssl = e.ssl ?? St;
		if (this.isUsingEmulator = void 0 !== e.emulatorOptions, this.credentials = e.credentials, this.ignoreUndefinedProperties = !!e.ignoreUndefinedProperties, this.localCache = e.localCache, e._customHeaders && (this._customHeaders = { ...e._customHeaders }), void 0 === e.cacheSizeBytes) this.cacheSizeBytes = mt;
		else {
			if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < bt) throw new s(aa.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
			this.cacheSizeBytes = e.cacheSizeBytes;
		}
		if (__PRIVATE_validateIsNotUsedTogether("experimentalForceLongPolling", e.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", e.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!e.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = false : void 0 === e.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!e.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions(e.experimentalLongPollingOptions ?? {}), function __PRIVATE_validateLongPollingOptions(e) {
			if (void 0 !== e.timeoutSeconds) {
				if (isNaN(e.timeoutSeconds)) throw new s(aa.INVALID_ARGUMENT, `invalid long polling timeout: ${e.timeoutSeconds} (must not be NaN)`);
				if (e.timeoutSeconds < 5) throw new s(aa.INVALID_ARGUMENT, `invalid long polling timeout: ${e.timeoutSeconds} (minimum allowed value is 5)`);
				if (e.timeoutSeconds > 30) throw new s(aa.INVALID_ARGUMENT, `invalid long polling timeout: ${e.timeoutSeconds} (maximum allowed value is 30)`);
			}
			...
			* limitations under the License.
			*/
			if ("number" != typeof e.grpcFlowControlWindow || e.grpcFlowControlWindow <= 0 || e.grpcFlowControlWindow > 2147483647 || !Number.isInteger(e.grpcFlowControlWindow)) throw new s(aa.INVALID_ARGUMENT, "grpcFlowControlWindow must be a positive integer and cannot exceed 2147483647");
...
var Dt = class Firestore {
	...
	* instance.
	*/ get app() {
		if (!this._app) throw new s(aa.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
		return this._app;
	}
	get _initialized() {
	...
	_setSettings(e) {
		if (this._settingsFrozen) throw new s(aa.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
		this._settings = new FirestoreSettingsImpl(e), this._emulatorOptions = e.emulatorOptions || {}, void 0 !== e.credentials && (this._authCredentials = function __PRIVATE_makeAuthCredentialsProvider(e) {
			...
			switch (e.type) {
				...
				default: throw new s(aa.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
			}
		}(e.credentials));
	}
	_getSettings() {
...
*/ function connectFirestoreEmulator(e, t, n, r = {}) {
	e = ra(e, Dt);
	const i = isCloudWorkstation(t), _ = e._getSettings(), o = {
		..._,
		emulatorOptions: e._getEmulatorOptions()
	}, a = `${t}:${n}`;
	i && pingServer(`https://${a}`), _.host !== vt && _.host !== a && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
	const u = {
		..._,
		host: a,
		ssl: i,
	...
	if (!deepEqual(u, o) && (e._setSettings(u), r.mockUserToken)) {
		let t, n;
		if ("string" == typeof r.mockUserToken) t = r.mockUserToken, n = User.MOCK_USER;
			...
			if (!i) throw new s(aa.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			n = new User(i);
		}
...
*/ var X = class X {
	...
	*/ get parent() {
	...
	withConverter(e) {
		return new X(this.firestore, e, this._key);
	}
	/**
	...
	*/ toJSON() {
	...
	static fromJSON(e, t, n) {
		if (__PRIVATE_validateJSON(t, X._jsonSchema)) return new X(e, n || null, new DocumentKey(ResourcePath.fromString(t.referencePath)));
	}
};
X._jsonSchemaVersion = "firestore/documentReference/1.0", X._jsonSchema = {
	type: property("string", X._jsonSchemaVersion),
...
var ea = class ea extends Query {
	...
	*/ get parent() {
		...
		return e.isEmpty() ? null : new X(this.firestore, null, new DocumentKey(e));
	}
	withConverter(e) {
...
function collection(e, t, ...n) {
	if (e = getModularInstance(e), __PRIVATE_validateNonEmptyArgument("collection", "path", t), e instanceof Dt) {
		const r = ResourcePath.fromString(t, ...n);
		return __PRIVATE_validateCollectionPath(r), new ea(e, null, r);
	}
	{
		if (!(e instanceof X || e instanceof ea)) throw new s(aa.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
function doc(e, t, ...n) {
	if (e = getModularInstance(e), 1 === arguments.length && (t = __PRIVATE_AutoId.newId()), __PRIVATE_validateNonEmptyArgument("doc", "path", t), e instanceof Dt) {
		const r = ResourcePath.fromString(t, ...n);
		return __PRIVATE_validateDocumentPath(r), new X(e, null, new DocumentKey(r));
	}
	{
		if (!(e instanceof X || e instanceof ea)) throw new s(aa.INVALID_ARGUMENT, "Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
		const r = e._path.child(ResourcePath.fromString(t, ...n));
...
var n = class n {
	...
	* {@link FirestoreError} if an error occurs.
	*/ static fromJSON(e) {
		if (__PRIVATE_validateJSON(e, n._jsonSchema)) {
			if (Array.isArray(e.vectorValues) && e.vectorValues.every(((e) => "number" == typeof e))) return new n(e.vectorValues);
			throw new s(aa.INVALID_ARGUMENT, "Expected 'vectorValues' field to be a number array");
		}
	}
};
...
/** Parse document data from a set() call. */ function __PRIVATE_parseSetData(e, t, n, r, i, _ = {}) {
	const o = e.createContext(_.merge || _.mergeFields ? 2 : 0, t, n, i);
	__PRIVATE_validatePlainObject("Data must be an object, but it was:", o, r);
	const a = __PRIVATE_parseObject(r, o);
	let u, c;
	if (_.merge) u = new FieldMask(o.fieldMask), c = o.fieldTransforms;
	else if (_.mergeFields) {
		const e = [];
		for (const r of _.mergeFields) {
			const i = ta(t, r, n);
			if (!o.contains(i)) throw new s(aa.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
			__PRIVATE_fieldMaskContains(e, i) || e.push(i);
		}
		u = new FieldMask(e), c = o.fieldTransforms.filter(((e) => u.covers(e.field)));
...
/** Parse update data from an update() call. */ function __PRIVATE_parseUpdateData(e, t, n, r) {
	...
	forEach(r, ((e, r) => {
		const o = __PRIVATE_fieldPathFromDotSeparatedString(t, e, n);
		r = getModularInstance(r);
		const a = i.childContextForFieldPath(o);
		if (r instanceof __PRIVATE_DeleteFieldValueImpl) s.push(o);
		else {
			const e = __PRIVATE_parseData(r, a);
			null != e && (s.push(o), _.set(o, e));
		}
	}));
	return new ParsedUpdateData(_, new FieldMask(s), i.fieldTransforms);
}
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, _) {
	const o = e.createContext(1, t, n), a = [ta(t, r, n)], u = [i];
	if (_.length % 2 != 0) throw new s(aa.INVALID_ARGUMENT, `Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);
	for (let e = 0; e < _.length; e += 2) a.push(ta(t, _[e])), u.push(_[e + 1]);
	...
	for (let e = a.length - 1; e >= 0; --e) if (!__PRIVATE_fieldMaskContains(c, a[e])) {
		...
		if (n instanceof __PRIVATE_DeleteFieldValueImpl) c.push(t);
		else {
			const e = __PRIVATE_parseData(n, r);
			null != e && (c.push(t), l.set(t, e));
		}
	}
	return new ParsedUpdateData(l, new FieldMask(c), o.fieldTransforms);
}
/**
...
function __PRIVATE_looksLikeJsonObject(e) {
	return !("object" != typeof e || null === e || e instanceof Array || e instanceof Date || e instanceof Timestamp || e instanceof GeoPoint || e instanceof Bytes || e instanceof X || e instanceof FieldValue || e instanceof n || __PRIVATE_isProtoValueSerializable(e));
}
...
function createError(e, t, n, r, i) {
	const _ = r && !r.isEmpty(), o = void 0 !== i;
	let a = `Function ${t}() called with invalid data`;
	n && (a += " (via `toFirestore()`)"), a += ". ";
	let u = "";
	return (_ || o) && (u += " (found", _ && (u += ` in field ${r}`), o && (u += ` in document ${i}`), u += ")"), new s(aa.INVALID_ARGUMENT, a + e + u);
}
...
*/ function __PRIVATE_fieldOrExpression(t) {
	if (__PRIVATE_isString$1(t)) return e(t);
	return __PRIVATE_valueToDefaultExpr(t);
}
/**
*
...
*/ var t = class {
	...
	*/ add(e) {
		return new x("add", [this, __PRIVATE_valueToDefaultExpr(e)], "add");
	}
	/**
	...
	*/ asBoolean() {
		...
		if (this instanceof x) return new __PRIVATE_BooleanFunctionExpression(this);
		throw new s("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
	}
	subtract(e) {
		return new x("subtract", [this, __PRIVATE_valueToDefaultExpr(e)], "subtract");
	}
	/**
	...
	*/ multiply(e) {
		return new x("multiply", [this, __PRIVATE_valueToDefaultExpr(e)], "multiply");
	}
	divide(e) {
		return new x("divide", [this, __PRIVATE_valueToDefaultExpr(e)], "divide");
	}
	mod(e) {
		return new x("mod", [this, __PRIVATE_valueToDefaultExpr(e)], "mod");
	}
	equal(e) {
		return new x("equal", [this, __PRIVATE_valueToDefaultExpr(e)], "equal").asBoolean();
	}
	notEqual(e) {
		return new x("not_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "notEqual").asBoolean();
	}
	lessThan(e) {
		return new x("less_than", [this, __PRIVATE_valueToDefaultExpr(e)], "lessThan").asBoolean();
	}
	lessThanOrEqual(e) {
		return new x("less_than_or_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "lessThanOrEqual").asBoolean();
	}
	greaterThan(e) {
		return new x("greater_than", [this, __PRIVATE_valueToDefaultExpr(e)], "greaterThan").asBoolean();
	}
	greaterThanOrEqual(e) {
		return new x("greater_than_or_equal", [this, __PRIVATE_valueToDefaultExpr(e)], "greaterThanOrEqual").asBoolean();
	}
	/**
	...
	*/ arrayConcat(e, ...t) {
	...
	arrayContains(e) {
		return new x("array_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayContains").asBoolean();
	}
	arrayContainsAll(e) {
	...
	*/ charLength() {
	...
	like(e) {
		return new x("like", [this, __PRIVATE_valueToDefaultExpr(e)], "like").asBoolean();
	}
	regexContains(e) {
		return new x("regex_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "regexContains").asBoolean();
	}
	regexFind(e) {
		return new x("regex_find", [this, __PRIVATE_valueToDefaultExpr(e)], "regexFind");
	}
	regexFindAll(e) {
		return new x("regex_find_all", [this, __PRIVATE_valueToDefaultExpr(e)], "regexFindAll");
	}
	regexMatch(e) {
		return new x("regex_match", [this, __PRIVATE_valueToDefaultExpr(e)], "regexMatch").asBoolean();
	}
	stringContains(e) {
		return new x("string_contains", [this, __PRIVATE_valueToDefaultExpr(e)], "stringContains").asBoolean();
	}
	startsWith(e) {
		return new x("starts_with", [this, __PRIVATE_valueToDefaultExpr(e)], "startsWith").asBoolean();
	}
	endsWith(e) {
		return new x("ends_with", [this, __PRIVATE_valueToDefaultExpr(e)], "endsWith").asBoolean();
	}
	/**
	...
	*/ trim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new x("trim", t, "trim");
	}
	/**
	...
	*/ ltrim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new x("ltrim", t, "ltrim");
	}
	/**
	...
	*/ rtrim(e) {
		const t = [this];
		return e && t.push(__PRIVATE_valueToDefaultExpr(e)), new x("rtrim", t, "rtrim");
	}
	/**
	...
	*/ isType(e) {
		return new x("is_type", [this, i(e)], "isType").asBoolean();
	}
	/**
	...
	*/ stringIndexOf(e) {
		return new x("string_index_of", [this, __PRIVATE_valueToDefaultExpr(e)], "stringIndexOf");
	}
	/**
	...
	*/ stringRepeat(e) {
		return new x("string_repeat", [this, __PRIVATE_valueToDefaultExpr(e)], "stringRepeat");
	}
	/**
	...
	*/ arraySlice(e, t) {
		...
		return void 0 !== t && n.push(__PRIVATE_valueToDefaultExpr(t)), new x("array_slice", n, "arraySlice");
	}
	/**
	...
	*/ arrayFirst() {
	...
	arrayFirstN(e) {
		return new x("array_first_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayFirstN");
	}
	/**
	...
	*/ arrayLast() {
	...
	arrayLastN(e) {
		return new x("array_last_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayLastN");
	}
	/**
	...
	*/ arrayMaximum() {
	...
	arrayMaximumN(e) {
		return new x("maximum_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayMaximumN");
	}
	/**
	...
	*/ arrayMinimum() {
	...
	arrayMinimumN(e) {
		return new x("minimum_n", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayMinimumN");
	}
	arrayIndexOf(e) {
	...
	arrayIndexOfAll(e) {
		return new x("array_index_of_all", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayIndexOfAll");
	}
	/**
	...
	*/ mapGet(e) {
		return new x("map_get", [this, i(e)], "mapGet");
	}
	/**
	...
	*/ getField(e) {
		return new x("get_field", [this, __PRIVATE_valueToDefaultExpr(e)], "get_field");
	}
	/**
	...
	*/ logicalMaximum(e, ...t) {
		const n = [e, ...t];
		return new x("maximum", [this, ...n.map(__PRIVATE_valueToDefaultExpr)], "logicalMaximum");
	}
	/**
	...
	*/ logicalMinimum(e, ...t) {
		const n = [e, ...t];
		return new x("minimum", [this, ...n.map(__PRIVATE_valueToDefaultExpr)], "minimum");
	}
	/**
	...
	*/ vectorLength() {
	...
	cosineDistance(e) {
		return new x("cosine_distance", [this, __PRIVATE_vectorToExpr(e)], "cosineDistance");
	}
	dotProduct(e) {
		return new x("dot_product", [this, __PRIVATE_vectorToExpr(e)], "dotProduct");
	}
	euclideanDistance(e) {
		return new x("euclidean_distance", [this, __PRIVATE_vectorToExpr(e)], "euclideanDistance");
	}
	/**
	...
	*/ timestampToUnixSeconds() {
	...
	timestampExtract(e, t) {
		const n = [this, __PRIVATE_valueToDefaultExpr(e)];
		return t && n.push(__PRIVATE_valueToDefaultExpr(t)), new x("timestamp_extract", n, "timestampExtract");
	}
	/**
	*
	...
	*/ parent() {
	...
	substring(e, t) {
		...
		return new x("substring", void 0 === t ? [this, n] : [
			this,
			n,
			__PRIVATE_valueToDefaultExpr(t)
		], "substring");
	...
	arrayGet(e) {
		return new x("array_get", [this, __PRIVATE_valueToDefaultExpr(e)], "arrayGet");
	}
	/**
	*
	...
	*/ isError() {
	...
	ifError(e) {
		const t = new x("if_error", [this, __PRIVATE_valueToDefaultExpr(e)], "ifError");
	...
	*/ isAbsent() {
	...
	mapRemove(e) {
		return new x("map_remove", [this, __PRIVATE_valueToDefaultExpr(e)], "mapRemove");
	}
	/**
	*
	...
	*/ mapMerge(e, ...t) {
	...
	pow(e) {
		return new x("pow", [this, __PRIVATE_valueToDefaultExpr(e)]);
	}
	trunc(e) {
		return void 0 === e ? new x("trunc", [this]) : new x("trunc", [this, __PRIVATE_valueToDefaultExpr(e)], "trunc");
	}
	round(e) {
		return void 0 === e ? new x("round", [this]) : new x("round", [this, __PRIVATE_valueToDefaultExpr(e)], "round");
	}
	/**
	...
	*/ stringReverse() {
	...
	ifAbsent(e) {
		return new x("if_absent", [this, __PRIVATE_valueToDefaultExpr(e)], "ifAbsent");
	}
	ifNull(e) {
		return new x("if_null", [this, __PRIVATE_valueToDefaultExpr(e)], "ifNull");
	}
	/**
	...
	*/ coalesce(e, ...t) {
	...
	join(e) {
		return new x("join", [this, __PRIVATE_valueToDefaultExpr(e)], "join");
	}
	/**
	...
	*/ arraySum() {
	...
	split(e) {
		return new x("split", [this, __PRIVATE_valueToDefaultExpr(e)]);
	}
	timestampTruncate(e, t) {
		const n = [this, __PRIVATE_valueToDefaultExpr(e)];
		return t && n.push(__PRIVATE_valueToDefaultExpr(t)), new x("timestamp_trunc", n);
	}
	/**
...
*/ var o = class extends t {
	...
	*/
	geoDistance(e) {
		return new x("geo_distance", [this, __PRIVATE_valueToDefaultExpr(e)], "geoDistance");
	}
	/**
	* @private
	* @internal
...
function G(e, t) {
	return new o("string" == typeof e ? Ce === e ? documentId$1()._internalPath : ta("field", e) : e._internalPath, t);
}
/**
* @internal
*
...
*/ var BooleanExpression = class BooleanExpression extends t {
	...
	*/ conditional(e, t) {
	...
	ifError(e) {
		const t = __PRIVATE_valueToDefaultExpr(e), n = new x("if_error", [this, t], "ifError");
...
*/ function b(e) {
	return function __PRIVATE__array(e, t) {
		return new x("array", e.map(((e) => __PRIVATE_valueToDefaultExpr(e))), t);
	}(e, "array");
}
...
var Y = class extends Stage {
	...
	constructor(e, t) {
		if (super(t), !e || 0 === e.length) throw new s(aa.INVALID_ARGUMENT, "Empty document paths are not allowed in DocumentsSource");
		const n = e.map(((e) => e.startsWith("/") ? e : "/" + e)), r = new Set(n);
		if (r.size !== n.length) throw new s(aa.INVALID_ARGUMENT, "Duplicate document paths are not allowed in DocumentsSource");
		this.hr = n, this.Tr = r;
	}
	/**
	* @internal
...
var $ = class $ extends Stage {
	...
	_toProto(e) {
		return {
			...super._toProto(e),
			args: [this.map._toProto(e), __PRIVATE_toStringValue($.Pr)]
		};
	}
	_readUserData(e) {
...
var __PRIVATE_RealtimePipeline = class __PRIVATE_RealtimePipeline {
	...
	*/ Ar(e, t) {
	...
	where(e) {
		...
		return this.Ar("where", e), t.push(new A(e, {})), new __PRIVATE_RealtimePipeline(this._db, this.userDataReader, this._userDataWriter, t);
	}
	limit(e) {
		const t = this.stages.map(((e) => e));
	...
	sort(e, ...t) {
		...
		return "orderings" in e ? n.push(new L(this.Ar("sort", e.orderings), {})) : n.push(new L(this.Ar("sort", [e, ...t]), {})), new __PRIVATE_RealtimePipeline(this._db, this.userDataReader, this._userDataWriter, n);
	}
	/**
	* @internal
	* @private
...
var __PRIVATE_CoreField = class {
	...
	evaluate(e, t) {
		...
		}(e, n)) : __PRIVATE_EvaluateResult.newValue(n) : __PRIVATE_EvaluateResult.mr();
	}
};
...
var __PRIVATE_CoreListOfExprs = class {
	...
	evaluate(e, t) {
		const n = this.expr.ur.map(((n) => __PRIVATE_toEvaluable(n).evaluate(e, t)));
		return n.some(((e) => e.gr())) ? __PRIVATE_EvaluateResult.dr() : __PRIVATE_EvaluateResult.newValue({ arrayValue: { values: n.map(((e) => e.value)) } });
	}
};
...
var __PRIVATE_BigIntOrDoubleArithmetics = class {
	...
	wr(e, t) {
		if (e.gr() || t.gr()) return __PRIVATE_EvaluateResult.dr();
		if (e.yr() || t.yr()) return __PRIVATE_EvaluateResult.pr();
		const n = e.value, r = t.value;
		if (!__PRIVATE_isDouble(n) && !isInteger(n) || !__PRIVATE_isDouble(r) && !isInteger(r)) return __PRIVATE_EvaluateResult.dr();
		if (__PRIVATE_isDouble(n) || __PRIVATE_isDouble(r)) {
			const e = this.br(n, r);
			return e ? __PRIVATE_EvaluateResult.newValue(e) : __PRIVATE_EvaluateResult.dr();
		}
		if (isInteger(n) && isInteger(r)) {
			const e = this.vr(n, r);
			return void 0 === e ? __PRIVATE_EvaluateResult.dr() : "number" == typeof e ? __PRIVATE_EvaluateResult.newValue({ doubleValue: e }) : e < Ot || e > Ft ? __PRIVATE_EvaluateResult.dr() : __PRIVATE_EvaluateResult.newValue({ integerValue: `${e}` });
		}
...
var __PRIVATE_CoreAnd = class {
	...
	evaluate(e, t) {
		...
		return n ? __PRIVATE_EvaluateResult.dr() : r ? __PRIVATE_EvaluateResult.pr() : __PRIVATE_EvaluateResult.newValue(Je);
	}
};
var __PRIVATE_CoreNot = class {
	...
	evaluate(e, t) {
		...
		switch (n.type) {
			...
			case "NULL": return __PRIVATE_EvaluateResult.pr();
			default: return __PRIVATE_EvaluateResult.dr();
		}
	}
};
var __PRIVATE_CoreOr = class {
	...
	evaluate(e, t) {
		...
		return n ? __PRIVATE_EvaluateResult.dr() : r ? __PRIVATE_EvaluateResult.pr() : __PRIVATE_EvaluateResult.newValue(Ye);
	}
};
var __PRIVATE_CoreXor = class __PRIVATE_CoreXor {
	...
	evaluate(e, t) {
		...
		return r ? __PRIVATE_EvaluateResult.pr() : __PRIVATE_EvaluateResult.newValue({ booleanValue: n });
	}
	static xor(e, t) {
		return (e || t) && !(e && t);
	}
	...
	evaluate(e, t) {
		...
		switch (r.type) {
			case "NULL":
				...
				break;
			case "ERROR":
			case "UNSET": return __PRIVATE_EvaluateResult.dr();
		}
		...
		if (n) return __PRIVATE_EvaluateResult.pr();
		...
		return n ? __PRIVATE_EvaluateResult.pr() : __PRIVATE_EvaluateResult.newValue(Ye);
	}
};
var __PRIVATE_CoreNotEqAny = class {
	...
	evaluate(e, t) {
		return new __PRIVATE_CoreNot(new x("not", [new x("equal_any", this.expr.params)])).evaluate(e, t);
	}
};
...
var __PRIVATE_CoreIsNotNan = class {
	...
	evaluate(e, t) {
		...
		return new __PRIVATE_CoreNot(new x("not", [new x("is_nan", this.expr.params)])).evaluate(e, t);
	}
};
var __PRIVATE_CoreIsNull = class {
	...
	evaluate(e, t) {
		...
		switch (__PRIVATE_toEvaluable(this.expr.params[0]).evaluate(e, t).type) {
			...
			case "UNSET":
			case "ERROR": return __PRIVATE_EvaluateResult.dr();
...
var __PRIVATE_CoreIsNotNull = class {
	...
	evaluate(e, t) {
		...
		return new __PRIVATE_CoreNot(new x("not", [new x("is_null", this.expr.params)])).evaluate(e, t);
	}
};
...
var __PRIVATE_CoreLogicalMaximum = class {
	...
	evaluate(e, t) {
		...
		return void 0 === r ? __PRIVATE_EvaluateResult.pr() : r;
	}
};
...
var __PRIVATE_CoreEq = class extends __PRIVATE_ComparisonBase {
	...
	Cr(e, t) {
		if (e.yr() && t.yr()) return __PRIVATE_EvaluateResult.newValue(Je);
		if (e.yr() || t.yr()) return __PRIVATE_EvaluateResult.newValue(Ye);
...
var __PRIVATE_CoreArrayContains = class {
	...
	evaluate(e, t) {
		return __PRIVATE_hardAssert(2 === this.expr.params.length, 52884), new __PRIVATE_CoreEqAny(new x("eq_any", [this.expr.params[1], this.expr.params[0]])).evaluate(e, t);
	}
};
	...
	evaluate(e, t) {
		...
		switch (n.type) {
			...
			case "STRING": {
				...
				return void 0 === e ? __PRIVATE_EvaluateResult.dr() : __PRIVATE_EvaluateResult.newValue({ integerValue: e });
			}
			default: return __PRIVATE_EvaluateResult.dr();
		}
	}
...
var __PRIVATE_StringSearchFunctionBase = class {
	...
	evaluate(e, t) {
		...
		return n ? __PRIVATE_EvaluateResult.pr() : this.Fr(r.value?.stringValue, i.value?.stringValue);
	}
};
var __PRIVATE_CoreLike = class extends __PRIVATE_StringSearchFunctionBase {
	Fr(e, t) {
		try {
			...
			return __PRIVATE_logWarn(`Invalid LIKE pattern converted to regex: ${t}, returning error. Error: ${e}`), __PRIVATE_EvaluateResult.dr();
		}
	}
};
var __PRIVATE_CoreRegexContains = class extends __PRIVATE_StringSearchFunctionBase {
	Fr(e, t) {
		try {
			...
			return __PRIVATE_logWarn(`Invalid regex pattern found in regex_contains: ${t}, returning error`), __PRIVATE_EvaluateResult.dr();
		}
	}
};
var __PRIVATE_CoreRegexMatch = class extends __PRIVATE_StringSearchFunctionBase {
	Fr(e, t) {
		try {
			...
			return __PRIVATE_logWarn(`Invalid regex pattern found in regex_match: ${t}, returning error`), __PRIVATE_EvaluateResult.dr();
		}
	}
};
...
var __PRIVATE_CoreStrConcat = class {
	...
	evaluate(e, t) {
		...
		return i ? __PRIVATE_EvaluateResult.pr() : __PRIVATE_EvaluateResult.newValue({ stringValue: r });
	}
};
var __PRIVATE_CoreMapGet = class {
	...
	evaluate(e, t) {
		...
		const r = __PRIVATE_toEvaluable(this.expr.params[1]).evaluate(e, t);
		if ("STRING" !== r.type) return __PRIVATE_EvaluateResult.dr();
		const i = n.value?.mapValue?.fields?.[r.value?.stringValue];
		return void 0 === i ? __PRIVATE_EvaluateResult.mr() : __PRIVATE_EvaluateResult.newValue(i);
	}
};
var __PRIVATE_DistanceBase = class {
	...
	evaluate(e, t) {
		...
		if (void 0 === s || void 0 === _ || s.values?.length !== _.values?.length) return __PRIVATE_EvaluateResult.dr();
		const o = this.Or(s, _);
		return void 0 === o || isNaN(o) ? __PRIVATE_EvaluateResult.dr() : __PRIVATE_EvaluateResult.newValue({ doubleValue: o });
	}
};
...
var __PRIVATE_CoreUnixMicrosToTimestamp = class extends __PRIVATE_UnixToTimestamp {
	toTimestamp(e) {
		if (!__PRIVATE_isMicrosInBounds(e)) return __PRIVATE_EvaluateResult.dr();
...
var __PRIVATE_CoreUnixSecondsToTimestamp = class extends __PRIVATE_UnixToTimestamp {
	toTimestamp(e) {
		if (!__PRIVATE_isSecondsInBounds(e)) return __PRIVATE_EvaluateResult.dr();
		const t = Number(e);
...
var __PRIVATE_TimestampToUnix = class {
	...
	evaluate(e, t) {
		...
		return __PRIVATE_isTimestampInBounds(r.seconds, r.nanoseconds) ? this.Mr(r) : __PRIVATE_EvaluateResult.dr();
	}
};
var __PRIVATE_CoreTimestampToUnixMicros = class extends __PRIVATE_TimestampToUnix {
	Mr(e) {
		const t = __PRIVATE_timestampToMicros(e);
		return __PRIVATE_isMicrosInBounds(t) ? __PRIVATE_EvaluateResult.newValue({ integerValue: `${t.toString()}` }) : __PRIVATE_EvaluateResult.dr();
	}
};
...
var __PRIVATE_CoreTimestampToUnixSeconds = class extends __PRIVATE_TimestampToUnix {
	Mr(e) {
		...
		return __PRIVATE_isSecondsInBounds(t) ? __PRIVATE_EvaluateResult.newValue({ integerValue: t.toString() }) : __PRIVATE_EvaluateResult.dr();
	}
};
	...
	evaluate(e, t) {
		...
		switch (i.type) {
			case "STRING":
				...
				}(i.value.stringValue), void 0 === s) return __PRIVATE_EvaluateResult.dr();
				break;
			case "NULL":
				n = true;
				break;
		...
		try {
			...
			if ("microsecond" !== s && o !== BigInt(0) && a / o !== BigInt(this.Nr(s))) return __PRIVATE_EvaluateResult.dr();
		} catch (e) {
			return __PRIVATE_logWarn(`Error during timestamp arithmetic: ${e}`), __PRIVATE_EvaluateResult.dr();
		}
		const u = fromTimestamp(r.value.timestampValue);
		if (!__PRIVATE_isTimestampInBounds(u.seconds, u.nanoseconds)) return __PRIVATE_EvaluateResult.dr();
		const c = __PRIVATE_timestampToMicros(u), l = this.Lr(c, a);
		if (!__PRIVATE_isMicrosInBounds(l)) return __PRIVATE_EvaluateResult.dr();
	...
	getPipelineFlavor() {
		return function getPipelineFlavor(e) {
			...
			return e.stages.forEach(((n, r) => {
				n._name !== M.name && n._name !== V.name || (t = "keyless"), n._name === y.name && "exact" === t && (t = "augmented"), n._name === w.name && r < e.stages.length - 1 && "exact" === t && (t = "augmented");
			})), t;
		}(this);
		/**
		* @license
...
function getPipelineSourceType(e) {
	const t = e.stages[0];
	return t instanceof H || t instanceof J || t instanceof Q || t instanceof Y ? t._name : "unknown";
}
function getPipelineCollection(e) {
	if ("collection" === getPipelineSourceType(e)) return e.stages[0].Er;
}
...
function getPipelineDocuments(e) {
	if ("documents" === getPipelineSourceType(e)) return e.stages[0].hr;
}
function __PRIVATE_canonifyExpr(e) {
	...
	if (e instanceof Constant) return `cst(${function __PRIVATE_canonifyConstantValue(e) {
		return null === e ? "null" : "number" == typeof e ? e.toString() : "string" == typeof e ? `"${e}"` : e instanceof X ? `ref(${e.path})` : e instanceof n ? `vec(${JSON.stringify(e)})` : JSON.stringify(e);
	}(e.value)})`;
	if (e instanceof x) return `fn(${e.name},[${e.params.map(__PRIVATE_canonifyExpr).join(",")}])`;
	if ("ListOfExpressions" === e.expressionType) return `list([${e.ur.map(__PRIVATE_canonifyExpr).join(",")}])`;
...
function __PRIVATE_canonifyStage(e) {
	...
	if (e instanceof H) return `${e._name}(${e.Er})`;
	if (e instanceof J) return `${e._name}(${e.collectionId})`;
	if (e instanceof Q) return `${e._name}()`;
	if (e instanceof Y) return `${e._name}(${e.hr.sort()})`;
...
function __PRIVATE_toCorePipeline(t, n) {
	const r = function __PRIVATE_rewriteStages(t) {
		let n = false;
		const r = [];
		for (const i of t) if (i instanceof L) if (n = true, i.orderings.some(((e) => e.expr instanceof o && e.expr.fieldName === Ce))) r.push(i);
		else {
			const t = i.orderings.map(((e) => e));
			t.push(e(Ce).ascending()), r.push(new L(t, {}));
		}
		else i instanceof v ? (n || (r.push(new L([e(Ce).ascending()], {})), n = true), r.push(i)) : r.push(i);
		return n || r.push(new L([e(Ce).ascending()], {})), r;
	}(t.stages);
	if (t.userDataReader) {
		const e = t.userDataReader.createContext(3, "toCorePipeline");
		r.forEach(((t) => t._readUserData(e)));
	}
	return new CorePipeline(t.userDataReader.serializer, r, n);
}
/**
* @license
* Copyright 2017 Google LLC
...
var __PRIVATE_FirestoreIndexValueWriter = class {
	...
	ei(e, t) {
		...
		else if ("booleanValue" in e) this.ni(t, 10), t.ri(e.booleanValue ? 1 : 0);
		else if ("integerValue" in e) this.ni(t, 15), t.ri(__PRIVATE_normalizeNumber(e.integerValue));
		else if ("doubleValue" in e) {
			const n = __PRIVATE_normalizeNumber(e.doubleValue);
			isNaN(n) ? this.ni(t, 13) : (this.ni(t, 15), __PRIVATE_isNegativeZero(n) ? t.ri(0) : t.ri(n));
		} else if ("timestampValue" in e) {
			let n = e.timestampValue;
			this.ni(t, 20), "string" == typeof n && (n = __PRIVATE_normalizeTimestamp(n)), t.ii(`${n.seconds || ""}`), t.ri(n.nanos || 0);
		} else if ("stringValue" in e) this.si(e.stringValue, t), this._i(t);
		else if ("bytesValue" in e) this.ni(t, 30), t.oi(__PRIVATE_normalizeByteString(e.bytesValue)), this._i(t);
		else if ("referenceValue" in e) this.ai(e.referenceValue, t);
		else if ("geoPointValue" in e) {
			const n = e.geoPointValue;
			this.ni(t, 45), t.ri(n.latitude || 0), t.ri(n.longitude || 0);
		} else "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.ni(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.ui(e.mapValue, t) : (this.ci(e.mapValue, t), this._i(t)) : "arrayValue" in e ? (this.li(e.arrayValue, t), this._i(t)) : l(19022, { Ei: e });
	}
	si(e, t) {
	...
	ci(e, t) {
		const n = e.fields || {};
		this.ni(t, 55);
		for (const e of Object.keys(n)) this.si(e, t), this.ei(n[e], t);
	}
	ui(e, t) {
		const n = e.fields || {};
		this.ni(t, 53);
		const r = je, i = n[r].arrayValue?.values?.length || 0;
		this.ni(t, 15), t.ri(__PRIVATE_normalizeNumber(i)), this.si(r, t), this.ei(n[r], t);
	}
	li(e, t) {
		const n = e.values || [];
		this.ni(t, 50);
		for (const e of n) this.ei(e, t);
	}
	ai(e, t) {
		this.ni(t, 37);
...
__PRIVATE_FirestoreIndexValueWriter.Ti = new __PRIVATE_FirestoreIndexValueWriter();
/**
* @license
* Copyright 2021 Google LLC
*
...
*/ var __PRIVATE_MemoryIndexManager = class {
	constructor() {
		this.Yi = new __PRIVATE_MemoryCollectionParentIndex();
	}
	addToCollectionParentIndex(e, t) {
		return this.Yi.add(t), PersistencePromise.resolve();
	}
	getCollectionParents(e, t) {
		return PersistencePromise.resolve(this.Yi.getEntries(t));
	}
	addFieldIndex(e, t) {
		return PersistencePromise.resolve();
	}
...
function evaluate(e, t, n) {
	if (t instanceof H) return function __PRIVATE_evaluateCollection(e, t, n) {
	...
	if (t instanceof J) return function __PRIVATE_evaluateCollectionGroup(e, t, n) {
		return n.filter(((e) => e.isFoundDocument() && e.key.getCollectionPath().lastSegment() === t.collectionId));
	}(0, t, n);
	if (t instanceof Q) return function __PRIVATE_evaluateDatabase(e, t, n) {
		return n.filter(((e) => e.isFoundDocument()));
	}(0, 0, n);
	if (t instanceof Y) return function __PRIVATE_evaluateDocuments(e, t, n) {
	...
	if (t instanceof L) return function __PRIVATE_evaluateSort(e, t, n) {
		const r = t.orderings.map(((e) => ({
			Os: __PRIVATE_toEvaluable(e.expr),
			direction: e.direction
		})));
		return [...n].sort(((t, n) => {
			for (const { Os: i, direction: s } of r) {
...
*/ var LocalDocumentsView = class {
	...
	*/ getNextDocuments(e, t, n, r) {
	...
	getDocumentsMatchingPipeline(e, t, n, r) {
		if ("collection_group" === getPipelineSourceType(t)) {
			...
			return this.indexManager.getCollectionParents(e, i).next(((_) => PersistencePromise.forEach(_, ((_) => {
				const o = function __PRIVATE_asCollectionPipelineAtPath(e, t) {
					const n = e.stages.map(((e) => e instanceof J ? new H(t.canonicalString(), {}) : e));
					return new CorePipeline(e.serializer, n);
				}(t, _.child(i));
				return this.getDocumentsMatchingPipeline(e, o, n, r).next(((e) => {
					e.forEach(((e, t) => {
						s = s.insert(e, t);
					}));
				}));
		...
		{
			let i;
			return this.getOverlaysForPipeline(e, t, n.largestBatchId).next(((_) => {
				switch (i = _, getPipelineSourceType(t)) {
					case "collection": return this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, i, r);
					case "documents":
						let _ = __PRIVATE_documentKeySet();
						for (const e of getPipelineDocuments(t)) _ = _.add(DocumentKey.fromPath(e));
						return this.remoteDocumentCache.getEntries(e, _);
					case "database": return this.remoteDocumentCache.getAllEntries(e);
					default: throw new s("invalid-argument", `Invalid pipeline source to execute offline: ${__PRIVATE_canonifyPipeline(t)}`);
				}
			})).next(((e) => this.retrieveMatchingLocalDocuments(i, e, ((e) => __PRIVATE_pipelineMatches(t, e)))));
		}
	}
	...
	getOverlaysForPipeline(e, t, n) {
		switch (getPipelineSourceType(t)) {
			case "collection": return this.documentOverlayCache.getOverlaysForCollection(e, ResourcePath.fromString(getPipelineCollection(t)), n);
			case "collection_group": throw new s("invalid-argument", `Unexpected collection group pipeline: ${__PRIVATE_canonifyPipeline(t)}`);
			case "documents": return this.documentOverlayCache.getOverlays(e, getPipelineDocuments(t).map(((e) => DocumentKey.fromPath(e))));
			case "database": return this.documentOverlayCache.getAllOverlays(e, n);
			default: throw new s("invalid-argument", `Failed to get overlays for pipeline: ${__PRIVATE_canonifyPipeline(t)}`);
		}
	}
};
/**
...
*/ var __PRIVATE_MemoryBundleCache = class {
	constructor(e) {
		this.serializer = e, this.Ks = /* @__PURE__ */ new Map(), this.Ws = /* @__PURE__ */ new Map();
	}
	getBundleMetadata(e, t) {
		return PersistencePromise.resolve(this.Ks.get(t));
	}
...
*/ var __PRIVATE_MemoryDocumentOverlayCache = class {
	constructor() {
		this.overlays = new SortedMap(DocumentKey.comparator), this.Qs = /* @__PURE__ */ new Map();
	}
	getOverlay(e, t) {
	...
	removeOverlaysForBatchId(e, t, n) {
		const r = this.Qs.get(n);
		return void 0 !== r && (r.forEach(((e) => this.overlays = this.overlays.remove(e))), this.Qs.delete(n)), PersistencePromise.resolve();
	}
	...
	Yr(e, t, n) {
		...
		if (null !== r) {
			const e = this.Qs.get(r.largestBatchId).delete(n.key);
			this.Qs.set(r.largestBatchId, e);
		}
		this.overlays = this.overlays.insert(n.key, new Overlay(t, n));
		let i = this.Qs.get(t);
		void 0 === i && (i = __PRIVATE_documentKeySet(), this.Qs.set(t, i)), this.Qs.set(t, i.add(n.key));
	}
};
/**
* @license
...
*/ var __PRIVATE_ReferenceSet = class {
	constructor() {
		this.Gs = new SortedSet(__PRIVATE_DocReference.zs), this.js = new SortedSet(__PRIVATE_DocReference.Hs);
	}
	...
	/** Add references to the given document keys for the given ID. */ Js(e, t) {
	...
	* ID.
	*/ removeReference(e, t) {
		this.Ys(new __PRIVATE_DocReference(e, t));
	}
	Zs(e, t) {
	...
	*/ Xs(e) {
	...
	containsKey(e) {
		const t = new __PRIVATE_DocReference(e, 0), n = this.Gs.firstAfterOrEqual(t);
...
var __PRIVATE_DocReference = class {
	...
	/** Compare by key then by ID */ static zs(e, t) {
		return DocumentKey.comparator(e.key, t.key) || __PRIVATE_primitiveComparator(e.n_, t.n_);
	}
	/** Compare by ID then by key */ static Hs(e, t) {
		return __PRIVATE_primitiveComparator(e.n_, t.n_) || DocumentKey.comparator(e.key, t.key);
	}
};
/**
* @license
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	constructor(e, t) {
		this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Qr = 1, this.r_ = new SortedSet(__PRIVATE_DocReference.zs);
	}
	checkEmpty(e) {
	...
	addMutationBatch(e, t, n, r) {
		const i = this.Qr;
		this.Qr++, this.mutationQueue.length > 0 && this.mutationQueue[this.mutationQueue.length - 1];
		const s = new MutationBatch(i, t, n, r);
		this.mutationQueue.push(s);
		for (const t of r) this.r_ = this.r_.add(new __PRIVATE_DocReference(t.key, i)), this.indexManager.addToCollectionParentIndex(e, t.key.path.popLast());
		return PersistencePromise.resolve(s);
	}
	lookupMutationBatch(e, t) {
		return PersistencePromise.resolve(this.i_(t));
	}
	getNextMutationBatchAfterBatchId(e, t) {
		const n = t + 1, r = this.s_(n), i = r < 0 ? 0 : r;
		return PersistencePromise.resolve(this.mutationQueue.length > i ? this.mutationQueue[i] : null);
	}
	getHighestUnacknowledgedBatchId() {
		return PersistencePromise.resolve(0 === this.mutationQueue.length ? Ke : this.Qr - 1);
	}
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		})), PersistencePromise.resolve(this.__(n));
	}
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		return this.r_.forEachWhile(((e) => {
			const t = e.key.path;
			return !!n.isPrefixOf(t) && (t.length === r && (_ = _.add(e.n_)), true);
		}), s), PersistencePromise.resolve(this.__(_));
	}
	__(e) {
		const t = [];
		return e.forEach(((e) => {
	...
	removeMutationBatch(e, t) {
		__PRIVATE_hardAssert(0 === this.o_(t.batchId, "removed"), 55003), this.mutationQueue.shift();
		let n = this.r_;
	...
	jr(e) {}
	containsKey(e, t) {
		const n = new __PRIVATE_DocReference(t, 0), r = this.r_.firstAfterOrEqual(n);
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
	...
	*/
	constructor(e) {
		this.a_ = e, this.docs = function __PRIVATE_documentEntryMap() {
			return new SortedMap(DocumentKey.comparator);
		}(), this.size = 0;
	}
	setIndexManager(e) {
	...
	*/ addEntry(e, t) {
		const n = t.key, r = this.docs.get(n), i = r ? r.size : 0, s = this.a_(t);
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.c_ = new ObjectMap(((e) => __PRIVATE_canonifyTargetOrPipeline(e)), __PRIVATE_targetOrPipelineEqual), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.l_ = 0, this.E_ = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.h_ = __PRIVATE_TargetIdGenerator.ys();
	}
	forEachTarget(e, t) {
		return this.c_.forEach(((e, n) => t(n))), PersistencePromise.resolve();
	}
	getLastRemoteSnapshotVersion(e) {
		return PersistencePromise.resolve(this.lastRemoteSnapshotVersion);
	}
	getHighestSequenceNumber(e) {
		return PersistencePromise.resolve(this.l_);
	}
	allocateTargetId(e) {
		return this.highestTargetId = this.h_.next(), PersistencePromise.resolve(this.highestTargetId);
	}
	setTargetsMetadata(e, t, n) {
		return n && (this.lastRemoteSnapshotVersion = n), t > this.l_ && (this.l_ = t), PersistencePromise.resolve();
	}
	Ss(e) {
		this.c_.set(e.target, e);
		const t = e.targetId;
		t > this.highestTargetId && (this.h_ = new __PRIVATE_TargetIdGenerator(t), this.highestTargetId = t), e.sequenceNumber > this.l_ && (this.l_ = e.sequenceNumber);
	}
	addTargetData(e, t) {
		return this.Ss(t), this.targetCount += 1, PersistencePromise.resolve();
	}
	updateTargetData(e, t) {
		return this.Ss(t), PersistencePromise.resolve();
	}
	removeTargetData(e, t) {
		return this.c_.delete(t.target), this.E_.Xs(t.targetId), this.targetCount -= 1, PersistencePromise.resolve();
	}
	removeTargets(e, t, n) {
		let r = 0;
		const i = [];
		return this.c_.forEach(((s, _) => {
			_.sequenceNumber <= t && null === n.get(_.targetId) && (this.c_.delete(s), i.push(this.removeMatchingKeysForTargetId(e, _.targetId)), r++);
	...
	addMatchingKeys(e, t, n) {
		return this.E_.Js(t, n), PersistencePromise.resolve();
	}
	...
	removeMatchingKeysForTargetId(e, t) {
		return this.E_.Xs(t), PersistencePromise.resolve();
	}
	...
	containsKey(e, t) {
		return PersistencePromise.resolve(this.E_.containsKey(t));
	}
};
/**
* @license
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	constructor(e, t) {
		this.T_ = {}, this.overlays = {}, this.P_ = new __PRIVATE_ListenSequence(0), this.R_ = false, this.R_ = true, this.I_ = new __PRIVATE_MemoryGlobalsCache(), this.referenceDelegate = e(this), this.A_ = new __PRIVATE_MemoryTargetCache(this);
		...
		}(((e) => this.referenceDelegate.V_(e))), this.serializer = new __PRIVATE_LocalSerializer(t), this.d_ = new __PRIVATE_MemoryBundleCache(this.serializer);
	}
	start() {
	...
	getMutationQueue(e, t) {
		...
		return n || (n = new __PRIVATE_MemoryMutationQueue(t, this.referenceDelegate), this.T_[e.toKey()] = n), n;
	}
	getGlobalsCache() {
		return this.I_;
	}
	...
	runTransaction(e, t, n) {
		...
		const r = new __PRIVATE_MemoryTransaction(this.P_.next());
	...
	p_(e, t) {
		return PersistencePromise.or(Object.values(this.T_).map(((n) => () => n.containsKey(e, t))));
	}
};
/**
...
var __PRIVATE_MemoryEagerDelegate = class __PRIVATE_MemoryEagerDelegate {
	constructor(e) {
		this.persistence = e, this.g_ = new __PRIVATE_ReferenceSet(), this.y_ = null;
	}
	static w_(e) {
	...
	addReference(e, t, n) {
		return this.g_.addReference(n, t), this.b_.delete(n.toString()), PersistencePromise.resolve();
	}
	removeReference(e, t, n) {
		return this.g_.removeReference(n, t), this.b_.add(n.toString()), PersistencePromise.resolve();
	}
	markPotentiallyOrphaned(e, t) {
		return this.b_.add(t.toString()), PersistencePromise.resolve();
	}
	removeTarget(e, t) {
	...
	m_(e) {
		...
		return PersistencePromise.forEach(this.b_, ((n) => {
	...
	v_(e, t) {
		return PersistencePromise.or([
			() => PersistencePromise.resolve(this.g_.containsKey(t)),
...
var __PRIVATE_MemoryLruDelegate = class __PRIVATE_MemoryLruDelegate {
	constructor(e, t) {
		this.persistence = e, this.S_ = new ObjectMap(((e) => __PRIVATE_encodeResourcePath(e.path)), ((e, t) => e.isEqual(t))), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
	}
	static w_(e, t) {
	...
	ir(e, t) {
		return PersistencePromise.forEach(this.S_, ((n, r) => this.Fs(e, n, r).next(((e) => e ? PersistencePromise.resolve() : t(r)))));
	}
	removeTargets(e, t, n) {
	...
	markPotentiallyOrphaned(e, t) {
		return this.S_.set(t, e.currentSequenceNumber), PersistencePromise.resolve();
	}
	removeTarget(e, t) {
	...
	addReference(e, t, n) {
		return this.S_.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
	}
	removeReference(e, t, n) {
		return this.S_.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
	}
...
var __PRIVATE_QueryEngine = class {
	constructor() {
		this.mo = false, this.po = false, this.yo = 100, this.wo = function __PRIVATE_getDefaultRelativeIndexReadCostPerDocument() {
			return isSafari() ? 8 : __PRIVATE_getAndroidVersion(getUA()) > 0 ? 6 : 4;
		}();
	}
	/** Sets the document view to query against. */ initialize(e, t) {
		this.bo = e, this.indexManager = t, this.mo = true;
	}
	/** Returns all local documents matching the specified query. */ getDocumentsMatchingQuery(e, t, n, r) {
		...
		return this.vo(e, t).next(((e) => {
			...
			if (!i.result) return this.So(e, t, r, n).next(((e) => {
				i.result = e;
			}));
		})).next((() => {
			if (i.result) return;
	...
	xo(e, t, n, r) {
		return __PRIVATE_isPipeline(t) ? PersistencePromise.resolve() : n.documentReadCount < this.yo ? (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "SDK will not create cache indexes for query:", __PRIVATE_stringifyQuery(t), "since it only creates cache indexes for collection contains", "more than or equal to", this.yo, "documents"), PersistencePromise.resolve()) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Query:", __PRIVATE_stringifyQuery(t), "scans", n.documentReadCount, "local documents and returns", r, "documents as results."), n.documentReadCount > this.wo * r ? (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "The SDK decides to create cache indexes for query:", __PRIVATE_stringifyQuery(t), "as using cache indexes may help improve performance."), this.indexManager.createTargetIndexes(e, __PRIVATE_queryToTarget(t))) : PersistencePromise.resolve());
	}
	/**
	...
	*/ vo(e, t) {
		...
		return this.indexManager.getIndexType(e, r).next(((t) => 0 === t ? null : (null !== n.limit && 1 === t && (n = __PRIVATE_queryWithLimit(n, null, "F"), r = __PRIVATE_queryToTarget(n)), this.indexManager.getDocumentsMatchingTarget(e, r).next(((t) => {
			...
			return this.bo.getDocuments(e, i).next(((t) => this.indexManager.getMinOffset(e, r).next(((r) => {
				const s = this.Co(n, t);
				return this.Fo(n, s, i, r.readTime) ? this.vo(e, __PRIVATE_queryWithLimit(n, null, "F")) : this.Oo(e, s, n, r);
			}))));
		})))));
	}
	/**
	...
	*/ So(e, t, n, r) {
		return (__PRIVATE_isPipeline(t) ? function __PRIVATE_pipelineMatchesAllDocuments(e) {
			...
			return true;
		}(t) : __PRIVATE_queryMatchesAllDocuments(t)) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.bo.getDocuments(e, n).next(((i) => {
			const s = this.Co(t, i);
			return this.Fo(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQueryOrPipeline(t)), this.Oo(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, Xe)).next(((e) => e)));
		}));
	}
	/** Applies the query filter and sorting to the provided documents.  */ Co(e, t) {
		let n, r;
	...
	*/ Fo(e, t, n, r) {
	...
	Do(e, t, n) {
		return __PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Using full collection scan to execute query:", __PRIVATE_stringifyQueryOrPipeline(t)), this.bo.getDocumentsMatchingQuery(e, t, IndexOffset.min(), n);
	}
	/**
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Mo = t, this.serializer = r, this.No = new SortedMap(__PRIVATE_primitiveComparator), this.Lo = new ObjectMap(((e) => __PRIVATE_canonifyTargetOrPipeline(e)), __PRIVATE_targetOrPipelineEqual), this.Bo = /* @__PURE__ */ new Map(), this.Uo = e.getRemoteDocumentCache(), this.A_ = e.getTargetCache(), this.d_ = e.getBundleCache(), this.ko(n);
	}
	ko(e) {
		this.documentOverlayCache = this.persistence.getDocumentOverlayCache(e), this.indexManager = this.persistence.getIndexManager(e), this.mutationQueue = this.persistence.getMutationQueue(e, this.indexManager), this.localDocuments = new LocalDocumentsView(this.Uo, this.mutationQueue, this.documentOverlayCache, this.indexManager), this.Uo.setIndexManager(this.indexManager), this.Mo.initialize(this.localDocuments, this.indexManager);
	}
	collectGarbage(e) {
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((e) => {
		const r = t.batch.keys(), i = n.Uo.newChangeBuffer({ trackRemovals: true });
...
*/ function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		const s = n.Uo.newChangeBuffer({ trackRemovals: true });
		i = n.No;
		const _ = [];
		t.targetChanges.forEach(((s, o) => {
			const a = i.get(o);
			if (!a) return;
			_.push(n.A_.removeMatchingKeys(e, s.removedDocuments, o).next((() => n.A_.addMatchingKeys(e, s.addedDocuments, o))));
			...
			}(a, u, s) && _.push(n.A_.updateTargetData(e, u));
		}));
		...
		if (t.documentUpdates.forEach(((r) => {
			...
			const t = n.A_.getLastRemoteSnapshotVersion(e).next(((t) => n.A_.setTargetsMetadata(e, e.currentSequenceNumber, r)));
			_.push(t);
		}
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e) => {
		let r;
		return n.A_.getTargetData(e, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.A_.allocateTargetId(e).next(((i) => (r = new TargetData(t, i, "TargetPurposeListen", e.currentSequenceNumber), n.A_.addTargetData(e, r).next((() => r)))))));
	})).then(((e) => {
		const r = n.No.get(e.targetId);
		return (null === r || e.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.No = n.No.insert(e.targetId, e), n.Lo.set(t, e.targetId)), e;
	}));
}
/**
...
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
	const r = __PRIVATE_debugCast(e), i = r.No.get(t), s = n ? "readwrite" : "readwrite-primary";
	try {
...
*/ function __PRIVATE_localStoreExecuteQuery(e, t, n) {
	...
	return r.persistence.runTransaction("Execute query", "readwrite", ((e) => function __PRIVATE_localStoreGetTargetData(e, t, n) {
		const r = __PRIVATE_debugCast(e), i = r.Lo.get(n);
		return void 0 !== i ? PersistencePromise.resolve(r.No.get(i)) : r.A_.getTargetData(t, n);
	...
	})).next((() => r.Mo.getDocumentsMatchingQuery(e, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet()))).next(((e) => (__PRIVATE_setMaxReadTime(r, e), {
		documents: e,
		Wo: s
	})))));
}
...
function __PRIVATE_setMaxReadTime(e, t) {
	t.forEach(((t, n) => {
		const r = n.key.getCollectionGroup(), i = e.Bo.get(r) || SnapshotVersion.min();
...
var __PRIVATE_OnlineStateTracker = class {
	constructor(e, t) {
		this.asyncQueue = e, this.onlineStateHandler = t, this.state = "Unknown", this.Jo = 0, this.Yo = null, this.Zo = true;
	}
	/**
	...
	*/ Xo() {
		0 === this.Jo && (this.ea("Unknown"), this.Yo = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, (() => (this.Yo = null, this.ta("Backend didn't respond within 10 seconds."), this.ea("Offline"), Promise.resolve()))));
	}
	/**
	...
	*/ na(e) {
		"Online" === this.state ? this.ea("Unknown") : (this.Jo++, this.Jo >= 1 && (this.ra(), this.ta(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.ea("Offline")));
	}
	/**
	...
	*/ set(e) {
		this.ra(), this.Jo = 0, "Online" === e && (this.Zo = false), this.ea(e);
	}
	ea(e) {
	...
	ta(e) {
		...
		this.Zo ? (__PRIVATE_logError(t), this.Zo = false) : __PRIVATE_logDebug("OnlineStateTracker", t);
	}
	ra() {
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.ia = [], this.sa = /* @__PURE__ */ new Map(), this._a = /* @__PURE__ */ new Map(), this.oa = /* @__PURE__ */ new Map(), this.aa = new __PRIVATE_TargetIdGenerator(1e3), this.ua = new __PRIVATE_TargetIdGenerator(1001), this.ca = /* @__PURE__ */ new Set(), this.la = [], this.Ea = i, this.Ea.Ke(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(hr, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.ca.add(4), await __PRIVATE_disableNetworkInternal(t), t.ha.set("Unknown"), t.ca.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
		})), this.ha = new __PRIVATE_OnlineStateTracker(n, r);
	}
};
async function __PRIVATE_enableNetworkInternal(e) {
	if (__PRIVATE_canUseNetwork(e)) for (const t of e.la) await t(true);
}
/**
* Temporarily disables the network. The network can be re-enabled using
* enableNetwork().
*/ async function __PRIVATE_disableNetworkInternal(e) {
	for (const t of e.la) await t(false);
}
/**
...
function __PRIVATE_remoteStoreListen(e, t) {
	...
	n.sa.set(i, s), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).Jt() && __PRIVATE_sendWatchRequest(n, s);
}
/**
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	__PRIVATE_logDebug(hr, "remoteStoreUnlisten removing mapping of SDK target ID to remote", t, i), n.sa.delete(i), n._a.delete(t), n.oa.delete(i), r.Jt() && __PRIVATE_sendUnwatchRequest(n, i), 0 === n.sa.size && (r.Jt() ? r.Xt() : __PRIVATE_canUseNetwork(n) && n.ha.set("Unknown"));
}
/**
* We need to increment the expected number of pending responses we're due
* from watch so we wait for the ack to process any messages from this target.
*/ function __PRIVATE_sendWatchRequest(e, t) {
	if (e.Ta.H(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
		const n = e.oa.get(t.targetId);
	...
	__PRIVATE_ensureWatchStream(e).Tn(t);
}
/**
* We need to increment the expected number of pending responses we're due
...
*/ function __PRIVATE_sendUnwatchRequest(e, t) {
	e.Ta.H(t), __PRIVATE_ensureWatchStream(e).Pn(t);
}
function __PRIVATE_startWatchStream(e) {
	e.Ta = new __PRIVATE_WatchChangeAggregator({
	...
	}), __PRIVATE_ensureWatchStream(e).start(), e.ha.Xo();
}
/**
* Returns whether the watch stream should be started because it's necessary
* and has not yet been started.
*/ function __PRIVATE_shouldStartWatchStream(e) {
	return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWatchStream(e).Ht() && e.sa.size > 0;
}
function __PRIVATE_canUseNetwork(e) {
	return 0 === __PRIVATE_debugCast(e).ca.size;
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
	__PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.ha.na(t), __PRIVATE_startWatchStream(e)) : e.ha.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.ha.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			...
			for (const r of t.targetIds) {
				if (e.sa.has(r)) {
					const t = e.oa.get(r);
					void 0 !== t && (await e.remoteSyncer.rejectListen(t, n), e._a.delete(t), e.oa.delete(r)), e.sa.delete(r);
				}
				e.Ta.removeTarget(r);
			}
		}(e, t);
	...
	else if (t instanceof __PRIVATE_DocumentWatchChange ? e.Ta.se(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.Ta.Ee(t) : e.Ta.ae(t), !n.isEqual(SnapshotVersion.min())) try {
		...
		n.compareTo(t) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e, t) {
			...
			n.targetChanges.forEach(((n, r) => {
				...
				const r = e.sa.get(t);
				if (!r) return;
				e.sa.set(t, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e, t);
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.ca.add(1), await __PRIVATE_disableNetworkInternal(e), e.ha.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(hr, "Retrying IndexedDB access"), await n(), e.ca.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_fillWritePipeline(e) {
	...
	let r = t.ia.length > 0 ? t.ia[t.ia.length - 1].batchId : Ke;
...
function __PRIVATE_shouldStartWriteStream(e) {
	return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWriteStream(e).Ht() && e.ia.length > 0;
}
function __PRIVATE_startWriteStream(e) {
	__PRIVATE_ensureWriteStream(e).start();
}
async function __PRIVATE_onWriteStreamOpen(e) {
	__PRIVATE_ensureWriteStream(e).dn();
}
async function __PRIVATE_onWriteHandshakeComplete(e) {
	const t = __PRIVATE_ensureWriteStream(e);
	for (const n of e.ia) t.In(n.mutations);
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Rn && await async function __PRIVATE_handleWriteError(e, t) {
		if (function __PRIVATE_isPermanentWriteError(e) {
			return __PRIVATE_isPermanentError(e) && e !== aa.ABORTED;
		}(t.code)) {
			const n = e.ia.shift();
			__PRIVATE_ensureWriteStream(e).Zt(), await __PRIVATE_executeWithRecovery(e, (() => e.remoteSyncer.rejectFailedWrite(n.batchId, t))), await __PRIVATE_fillWritePipeline(e);
		}
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.ca.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.ha.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.ca.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
* Toggles the network state when the client gains or loses its primary lease.
*/ async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	t ? (n.ca.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.ca.add(2), await __PRIVATE_disableNetworkInternal(n), n.ha.set("Unknown"));
}
/**
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.Pa || (e.Pa = function __PRIVATE_newPersistentWatchStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		return r.mn(), new __PRIVATE_PersistentListenStream(t, r.connection, r.authCredentials, r.appCheckCredentials, r.serializer, n);
	}(e.datastore, e.asyncQueue, {
		ut: __PRIVATE_onWatchStreamConnected.bind(null, e),
		lt: __PRIVATE_onWatchStreamOpen.bind(null, e),
		ht: __PRIVATE_onWatchStreamClose.bind(null, e),
		hn: __PRIVATE_onWatchStreamChange.bind(null, e)
	}), e.la.push((async (t) => {
		t ? (e.Pa.Zt(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.ha.set("Unknown")) : (await e.Pa.stop(), __PRIVATE_cleanUpWatchStreamState(e));
	}))), e.Pa;
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.Ra || (e.Ra = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		return r.mn(), new __PRIVATE_PersistentWriteStream(t, r.connection, r.authCredentials, r.appCheckCredentials, r.serializer, n);
	}(e.datastore, e.asyncQueue, {
		ut: () => Promise.resolve(),
		lt: __PRIVATE_onWriteStreamOpen.bind(null, e),
		ht: __PRIVATE_onWriteStreamClose.bind(null, e),
		An: __PRIVATE_onWriteHandshakeComplete.bind(null, e),
		Vn: __PRIVATE_onMutationResult.bind(null, e)
	}), e.la.push((async (t) => {
		t ? (e.Ra.Zt(), await __PRIVATE_fillWritePipeline(e)) : (await e.Ra.stop(), e.ia.length > 0 && (__PRIVATE_logDebug(hr, `Stopping write stream with ${e.ia.length} pending writes`), e.ia = []));
	}))), e.Ra;
}
/**
* @license
...
var __PRIVATE_AsyncObserver = class {
	...
	error(e) {
		this.muted || (this.observer.error ? this.Ia(this.observer.error, e) : __PRIVATE_logError("Uncaught Error in snapshot listener:", e.toString()));
	}
	Aa() {
		this.muted = true;
	}
...
var DelayedOperation = class DelayedOperation {
	...
	*/ cancel(e) {
		null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new s(aa.CANCELLED, "Operation cancelled" + (e ? ": " + e : ""))));
	}
	handleDelayElapsed() {
...
*/ function __PRIVATE_wrapInUserErrorIfRecoverable(e, t) {
	if (__PRIVATE_logError("AsyncQueue", `${t}: ${e}`), __PRIVATE_isIndexedDbTransactionError(e)) return new s(aa.UNAVAILABLE, `${t}: ${e}`);
	throw e;
}
/**
* @license
...
var __PRIVATE_MemorySharedClientState = class {
	constructor() {
		this.du = new __PRIVATE_LocalClientState(), this.fu = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
	}
	...
	start() {
		return this.du = new __PRIVATE_LocalClientState(), Promise.resolve();
	}
...
*/ var __PRIVATE_DocumentChangeSet = class {
	...
	track(e) {
		...
		n ? 0 !== e.type && 3 === n.type ? this.mu = this.mu.insert(t, e) : 3 === e.type && 1 !== n.type ? this.mu = this.mu.insert(t, {
			type: n.type,
			doc: e.doc
		}) : 2 === e.type && 2 === n.type ? this.mu = this.mu.insert(t, {
			type: 2,
			doc: e.doc
		}) : 2 === e.type && 0 === n.type ? this.mu = this.mu.insert(t, {
			type: 0,
			doc: e.doc
		}) : 1 === e.type && 0 === n.type ? this.mu = this.mu.remove(t) : 1 === e.type && 2 === n.type ? this.mu = this.mu.insert(t, {
			type: 1,
			doc: n.doc
		}) : 0 === e.type && 1 === n.type ? this.mu = this.mu.insert(t, {
			type: 2,
			doc: e.doc
		}) : l(63341, {
			ye: e,
...
*/ var __PRIVATE_QueryListenersInfo = class {
	...
	bu() {
		return this.wu.some(((e) => e.vu()));
	}
};
var __PRIVATE_EventManagerImpl = class {
	constructor() {
		this.queries = __PRIVATE_newQueriesObjectMap(), this.onlineState = "Unknown", this.Su = /* @__PURE__ */ new Set();
	}
	terminate() {
		(function __PRIVATE_errorAllTargets(e, t) {
			...
			n.queries = __PRIVATE_newQueriesObjectMap(), r.forEach(((e, n) => {
				for (const e of n.wu) e.onError(t);
			}));
		})(this, new s(aa.ABORTED, "Firestore shutting down"));
	}
};
...
async function __PRIVATE_eventManagerListen(e, t) {
	...
	s ? !s.bu() && t.vu() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.vu() ? 0 : 1);
	try {
		switch (r) {
			case 0:
				s.yu = await n.onListen(
					i,
					/** enableRemoteListen= */
					!0
				);
	...
	if (n.queries.set(i, s), s.wu.push(t), t.Du(n.onlineState), s.yu) t.xu(s.yu) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		const e = s.wu.indexOf(t);
		e >= 0 && (s.wu.splice(e, 1), 0 === s.wu.length ? i = t.vu() ? 0 : 1 : !s.bu() && t.vu() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e of t) {
		...
		if (i) {
			for (const t of i.wu) t.xu(e) && (r = true);
			i.yu = e;
		}
	}
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
	...
	if (i) for (const e of i.wu) e.onError(n);
	r.queries.delete(t);
}
...
var __PRIVATE_QueryListener = class {
	constructor(e, t, n) {
		this.query = e, this.Cu = t, this.Fu = false, this.Ou = null, this.onlineState = "Unknown", this.options = n || {};
	}
	/**
	...
	*/ xu(e) {
		...
		let t = false;
		return this.Fu ? this.Mu(e) && (this.Cu.next(e), t = true) : this.Nu(e, this.onlineState) && (this.Lu(e), t = true), this.Ou = e, t;
	}
	onError(e) {
		this.Cu.error(e);
	}
	/** Returns whether a snapshot was raised. */ Du(e) {
		this.onlineState = e;
		let t = false;
		return this.Ou && !this.Fu && this.Nu(this.Ou, e) && (this.Lu(this.Ou), t = true), t;
	}
	Nu(e, t) {
	...
	Lu(e) {
		e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.Fu = true, this.Cu.next(e);
	}
	vu() {
...
*/ var __PRIVATE_View = class {
	constructor(e, t) {
		this.query = e, this.Gu = t, this.zu = null, this.hasCachedResults = false, this.current = false, this.ju = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.Hu = __PRIVATE_isPipeline(e) ? __PRIVATE_newPipelineComparator(e) : __PRIVATE_newQueryComparator(e), this.Ju = new DocumentSet(this.Hu);
	}
	/**
	...
	*/ Zu(e, t) {
		const n = t ? t.Xu : new __PRIVATE_DocumentChangeSet(), r = t ? t.Ju : this.Ju;
		let i = t ? t.mutatedKeys : this.mutatedKeys, s = r, _ = false;
		const [o, a] = this.ec(this.query, r);
		e.inorderTraversal(((e, t) => {
			...
			if (u && c) u.data.isEqual(c.data) ? l !== E && (n.track({
				type: 3,
				doc: c
			}), h = true) : this.tc(u, c) || (n.track({
				type: 2,
				doc: c
			}), h = true, (o && this.Hu(c, o) > 0 || a && this.Hu(c, a) < 0) && (_ = true));
			else !u && c ? (n.track({
				type: 0,
				doc: c
			}), h = true) : u && !c && (n.track({
	...
	ec(e, t) {
		...
		return ["F" === e.limitType && t.size === this.nc(this.query) ? t.last() : null, "L" === e.limitType && t.size === this.nc(this.query) ? t.first() : null];
	}
	tc(e, t) {
	...
	*/
	applyChanges(e, t, n, r) {
		...
		s.sort(((e, t) => function __PRIVATE_compareChangeType(e, t) {
			const order = (e) => {
				switch (e) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return l(20277, { ye: e });
				}
			};
			return order(e) - order(t);
		}(e.type, t.type) || this.Hu(e.doc, t.doc))), this.sc(n), r = r ?? false;
		/**
		* @license
		* Copyright 2020 Google LLC
		*
		...
		* limitations under the License.
		*/
		const _ = t && !r ? this._c() : [], o = 0 === this.ju.size && this.current && !r ? 1 : 0, a = o !== this.zu;
		if (this.zu = o, 0 !== s.length || a) return {
			snapshot: new ViewSnapshot(this.query, e.Ju, i, s, e.mutatedKeys, 0 === o, a, false, !!n && n.resumeToken.approximateByteSize() > 0),
			oc: _
		};
		return { oc: _ };
	}
	...
	*/ Du(e) {
		return this.current && "Offline" === e ? (this.current = false, this.applyChanges({
			Ju: this.Ju,
			Xu: new __PRIVATE_DocumentChangeSet(),
	...
	*/ sc(e) {
	...
	_c() {
		...
		const e = this.ju;
		this.ju = __PRIVATE_documentKeySet(), this.Ju.forEach(((e) => {
			this.ac(e.key) && (this.ju = this.ju.add(e.key));
		}));
		const t = [];
		return e.forEach(((e) => {
			this.ju.has(e) || t.push(new __PRIVATE_RemovedLimboDocument(e));
		})), this.ju.forEach(((n) => {
	...
	*/
	uc(e) {
		this.Gu = e.Wo, this.ju = __PRIVATE_documentKeySet();
	...
	*/
	cc() {
		return ViewSnapshot.fromInitialDocuments(this.query, this.Ju, this.mutatedKeys, 0 === this.zu, this.hasCachedResults);
	}
};
var dr = "SyncEngine";
/**
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Ec = {}, this.hc = new ObjectMap(((e) => __PRIVATE_canonifyQueryOrPipeline(e)), __PRIVATE_queryOrPipelineEqual), this.Tc = /* @__PURE__ */ new Map(), this.Pc = /* @__PURE__ */ new Set(), this.Rc = new SortedMap(DocumentKey.comparator), this.Ic = /* @__PURE__ */ new Map(), this.Ac = new __PRIVATE_ReferenceSet(), this.Vc = {}, this.dc = /* @__PURE__ */ new Map(), this.fc = __PRIVATE_TargetIdGenerator.ws(), this.onlineState = "Unknown", this.mc = void 0;
	}
	get isPrimaryClient() {
		return true === this.mc;
	}
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
	...
	let i;
	const s = r.hc.get(t);
	return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.cc()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
		r,
		t,
		n,
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.gc = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.Zu(n);
		i.Fo && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, false).then((({ documents: e }) => t.view.Zu(e, i))));
		...
		return __PRIVATE_updateTrackedLimbos(e, t.targetId, o.oc), o.snapshot;
	}(e, t, n, r);
	const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, true), _ = new __PRIVATE_View(t, s.Wo), o = _.Zu(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = _.applyChanges(o, e.isPrimaryClient, a);
	__PRIVATE_updateTrackedLimbos(e, n, u.oc);
	const c = new __PRIVATE_QueryView(t, n, _);
	return e.hc.set(t, c), e.Tc.has(n) ? e.Tc.get(n).push(t) : e.Tc.set(n, [t]), u.snapshot;
}
/** Stops listening to the query. */ async function __PRIVATE_syncEngineUnlisten(e, t, n) {
	const r = __PRIVATE_debugCast(e), i = r.hc.get(t), s = r.Tc.get(i.targetId);
	if (s.length > 1) return r.Tc.set(i.targetId, s.filter(((e) => !__PRIVATE_queryOrPipelineEqual(e, t)))), void r.hc.delete(t);
...
/** Unlistens to the remote store while still listening to the cache. */ async function __PRIVATE_triggerRemoteStoreUnlisten(e, t) {
	const n = __PRIVATE_debugCast(e), r = n.hc.get(t), i = n.Tc.get(r.targetId);
...
*/ async function __PRIVATE_syncEngineWrite(e, t, n) {
	...
	try {
		...
		r.sharedClientState.addPendingMutation(e.batchId), function __PRIVATE_addMutationCallback(e, t, n) {
			...
			r = r.insert(t, n), e.Vc[e.currentUser.toKey()] = r;
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e, t) => {
			const r = n.Ic.get(t);
			r && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1, 22616), e.addedDocuments.size > 0 ? r.lc = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.lc, 14607) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.lc, 42227), r.lc = !1));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.hc.forEach(((n, r) => {
			...
			n.queries.forEach(((e, n) => {
				for (const e of n.wu) e.Du(t) && (r = true);
			})), r && __PRIVATE_raiseSnapshotsInSyncEvent(n);
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, __PRIVATE_mutableDocumentMap(), n)), r.Rc = r.Rc.remove(s), r.Ic.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function __PRIVATE_processUserCallback(e, t, n) {
	const r = __PRIVATE_debugCast(e);
	let i = r.Vc[r.currentUser.toKey()];
	if (i) {
		const e = i.get(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	for (const r of e.Tc.get(t)) e.hc.delete(r), n && e.Ec.yc(r, n);
	if (e.Tc.delete(t), e.isPrimaryClient) e.Ac.Xs(t).forEach(((t) => {
		e.Ac.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
function __PRIVATE_removeLimboTarget(e, t) {
	e.Pc.delete(t.path.canonicalString());
	const n = e.Rc.get(t);
	null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.Rc = e.Rc.remove(t), e.Ic.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Ac.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
	else if (r instanceof __PRIVATE_RemovedLimboDocument) {
		__PRIVATE_logDebug(dr, "Document no longer in limbo: " + r.key), e.Ac.removeReference(r.key, t);
		e.Ac.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
	} else l(19791, { wc: r });
}
function __PRIVATE_trackLimboChange(e, t) {
	const n = t.key, r = n.path.canonicalString();
	e.Rc.get(n) || e.Pc.has(r) || (__PRIVATE_logDebug(dr, "New document in limbo: " + n), e.Pc.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
/**
...
*/ function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
	for (; e.Pc.size > 0 && e.Rc.size < e.maxConcurrentLimboResolutions;) {
		const t = e.Pc.values().next().value;
		e.Pc.delete(t);
		const n = new DocumentKey(ResourcePath.fromString(t)), r = e.fc.next();
		e.Ic.set(r, new LimboResolution(n)), e.Rc = e.Rc.insert(n, r), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.yn));
	}
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	const r = __PRIVATE_debugCast(e), i = [], s = [], _ = [];
	r.hc.isEmpty() || (r.hc.forEach(((e, o) => {
		_.push(r.gc(o, t, n).then(((e) => {
			...
			if (e) {
				i.push(e);
				const t = __PRIVATE_LocalViewChanges.fo(o.targetId, e);
				s.push(t);
			}
		})));
	})), await Promise.all(_), r.Ec.hn(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
		const n = __PRIVATE_debugCast(e);
		try {
			await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", ((e) => PersistencePromise.forEach(t, ((t) => PersistencePromise.forEach(t.Ao, ((r) => n.persistence.referenceDelegate.addReference(e, t.targetId, r))).next((() => PersistencePromise.forEach(t.Vo, ((r) => n.persistence.referenceDelegate.removeReference(e, t.targetId, r)))))))));
		} catch (e) {
			if (!__PRIVATE_isIndexedDbTransactionError(e)) throw e;
		...
		for (const e of t) {
			const t = e.targetId;
			if (!e.fromCache) {
				const e = n.No.get(t), r = e.snapshotVersion, i = e.withLastLimboFreeSnapshotVersion(r);
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		__PRIVATE_logDebug(dr, "User change. New user:", t.toKey());
		...
		n.currentUser = t, function __PRIVATE_rejectOutstandingPendingWritesCallbacks(e, t) {
			e.dc.forEach(((e) => {
				e.forEach(((e) => {
					e.reject(new s(aa.CANCELLED, t));
				}));
			})), e.dc.clear();
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e.removedBatchIds, e.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.qo);
	}
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
	const n = __PRIVATE_debugCast(e), r = n.Ic.get(t);
	if (r && r.lc) return __PRIVATE_documentKeySet().add(r.key);
	{
...
function __PRIVATE_ensureWatchCallbacks(e) {
	const t = __PRIVATE_debugCast(e);
	return t.remoteStore.remoteSyncer.applyRemoteEvent = __PRIVATE_syncEngineApplyRemoteEvent.bind(null, t), t.remoteStore.remoteSyncer.getRemoteKeysForTarget = __PRIVATE_syncEngineGetRemoteKeysForTarget.bind(null, t), t.remoteStore.remoteSyncer.rejectListen = __PRIVATE_syncEngineRejectListen.bind(null, t), t.Ec.hn = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager), t.Ec.yc = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager), t;
}
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
	...
	async initialize(e) {
		this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.vc(e), this.persistence = this.Sc(e), await this.persistence.start(), this.localStore = this.Dc(e), this.gcScheduler = this.xc(e, this.localStore), this.indexBackfillerScheduler = this.Cc(e, this.localStore);
	}
	xc(e, t) {
		return null;
	}
	...
	Sc(e) {
		return new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.w_, this.serializer);
	}
	vc(e) {
...
var __PRIVATE_LruGcMemoryOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	...
	Sc(e) {
		...
		return new __PRIVATE_MemoryPersistence(((e) => __PRIVATE_MemoryLruDelegate.w_(e, t)), this.serializer);
	}
};
/**
...
*/ var OnlineComponentProvider = class {
	...
	createRemoteStore(e) {
		return function __PRIVATE_newRemoteStore(e, t, n, r, i) {
			...
			return __PRIVATE_BrowserConnectivityMonitor.Je() ? new __PRIVATE_BrowserConnectivityMonitor() : new __PRIVATE_NoopConnectivityMonitor();
		}());
		/**
		* @license
		* Copyright 2017 Google LLC
	...
	createSyncEngine(e, t) {
		return function __PRIVATE_newSyncEngine(e, t, n, r, i, s, _) {
			...
			return _ && (o.mc = true), o;
		}(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, e.initialUser, e.maxConcurrentLimboResolutions, t);
	}
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(hr, "RemoteStore shutting down."), t.ca.add(5), await __PRIVATE_disableNetworkInternal(t), t.Ea.shutdown(), t.ha.set("Unknown");
	...
	if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
		...
		try {
			...
			if (!function __PRIVATE_canFallbackFromIndexedDbError(e) {
				return "FirebaseError" === e.name ? e.code === aa.FAILED_PRECONDITION || e.code === aa.UNIMPLEMENTED : !("undefined" != typeof DOMException && e instanceof DOMException) || 22 === e.code || 20 === e.code || 11 === e.code;
			}(n)) throw n;
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_readDocumentViaSnapshotListener(e, t, n, r, i) {
		const _ = new __PRIVATE_AsyncObserver({
			next: (a) => {
				_.Aa(), t.enqueueAndForget((() => __PRIVATE_eventManagerUnlisten(e, o)));
				const u = a.docs.has(n);
				!u && a.fromCache ? i.reject(new s(aa.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && a.fromCache && r && "server" === r.source ? i.reject(new s(aa.UNAVAILABLE, "Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to \"server\" to retrieve the cached document.)")) : i.resolve(a);
			},
			error: (e) => i.reject(e)
		}), o = new __PRIVATE_QueryListener(__PRIVATE_newQueryForPath(n.path), _, {
...
function __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(e, t, n = {}) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_executeQueryViaSnapshotListener(e, t, n, r, i) {
		const _ = new __PRIVATE_AsyncObserver({
			next: (n) => {
				_.Aa(), t.enqueueAndForget((() => __PRIVATE_eventManagerUnlisten(e, o))), n.fromCache && "server" === r.source ? i.reject(new s(aa.UNAVAILABLE, "Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to \"server\" to retrieve the cached documents.)")) : i.resolve(n);
			},
			error: (e) => i.reject(e)
		}), o = new __PRIVATE_QueryListener(n instanceof __PRIVATE_RealtimePipeline ? __PRIVATE_toCorePipeline(n) : n, _, {
			includeMetadataChanges: true,
			waitForSyncWhenOnline: true
		});
		return __PRIVATE_eventManagerListen(e, o);
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.Wc = [], this.Qc = false, this.Gc = [], this.zc = null, this.jc = false, this.Hc = false, this.Jc = [], this.jt = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.Yc = () => {
			const e = getDocument();
			e && __PRIVATE_logDebug(mr, "Visibility state changed to " + e.visibilityState), this.jt.qt();
		}, this.Zc = e;
		const t = getDocument();
	...
	*/ enqueueAndForget(e) {
	...
	enterRestrictedMode(e) {
		if (!this.Qc) {
			this.Qc = true, this.Hc = e || false;
			const t = getDocument();
			t && "function" == typeof t.removeEventListener && t.removeEventListener("visibilitychange", this.Yc);
		}
	}
	enqueue(e) {
		if (this.Xc(), this.Qc) return new Promise((() => {}));
		const t = new __PRIVATE_Deferred();
		return this.el((() => this.Qc && this.Hc ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise))).then((() => t.promise));
	}
	enqueueRetryable(e) {
		this.enqueueAndForget((() => (this.Wc.push(e), this.tl())));
	}
	/**
	...
	*/ async tl() {
		if (0 !== this.Wc.length) {
			try {
				await this.Wc[0](), this.Wc.shift(), this.jt.reset();
			} catch (e) {
				if (!__PRIVATE_isIndexedDbTransactionError(e)) throw e;
				__PRIVATE_logDebug(mr, "Operation failed with retryable error: " + e);
			}
			this.Wc.length > 0 && this.jt.Ut((() => this.tl()));
		}
	}
	el(e) {
		const t = this.Zc.then((() => (this.jc = true, e().catch(((e) => {
			this.zc = e, this.jc = false;
			throw __PRIVATE_logError("INTERNAL UNHANDLED ERROR: ", __PRIVATE_getMessageOrStack(e)), e;
		})).then(((e) => (this.jc = false, e))))));
		return this.Zc = t, t;
	}
	enqueueAfterDelay(e, t, n) {
		this.Xc(), this.Jc.indexOf(e) > -1 && (t = 0);
		const r = DelayedOperation.createAndSchedule(this, e, t, n, ((e) => this.nl(e)));
		return this.Gc.push(r), r;
	}
	Xc() {
		this.zc && l(47125, { rl: __PRIVATE_getMessageOrStack(this.zc) });
	}
	...
	* exists.
	*/ sl(e) {
		for (const t of this.Gc) if (t.timerId === e) return true;
		return false;
	}
	/**
	...
	*/ _l(e) {
		return this.il().then((() => {
			this.Gc.sort(((e, t) => e.targetTimeMs - t.targetTimeMs));
			for (const t of this.Gc) if (t.skipDelay(), "all" !== e && t.timerId === e) break;
			return this.il();
		}));
	}
	/**
	...
	*/ ol(e) {
	...
	/** Called once a DelayedOperation is run or canceled. */ nl(e) {
		const t = this.Gc.indexOf(e);
		this.Gc.splice(t, 1);
	}
};
/**
...
* @internal
*/ function oa(e) {
	if (e._terminated) throw new s(aa.FAILED_PRECONDITION, "The client has already been terminated.");
...
*/ var Jt = class DocumentSnapshot {
	...
	*/ data() {
		if (this._document) {
			if (this._converter) {
				const t = new kt(this._firestore, this._userDataWriter, this._key, this._document, null);
...
var kt = class QueryDocumentSnapshot extends Jt {
	/**
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
	if ("L" === t.limitType && 0 === t.explicitOrderBy.length) throw new s(aa.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
/**
* @license
* Copyright 2020 Google LLC
...
* access will return 'undefined'. You can use the `exists()` method to
* explicitly verify a document's existence.
*/ var DocumentSnapshot = class DocumentSnapshot extends Jt {
	/** @hideconstructor protected */
		...
		return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function __PRIVATE_changesFromSnapshot(t, e) {
			if (t._snapshot.oldDocs.isEmpty()) {
				...
				return t._snapshot.docChanges.map(((n) => {
					__PRIVATE_isPipeline(t._snapshot.query) ? __PRIVATE_newPipelineComparator(t._snapshot.query) : t.query._query;
			...
			}
			{
				...
				return t._snapshot.docChanges.filter(((t) => e || 3 !== t.type)).map(((e) => {
					...
					let s = -1, o = -1;
					return 0 !== e.type && (s = n.indexOf(e.doc.key), n = n.delete(e.doc.key)), 1 !== e.type && (n = n.add(e.doc), o = n.indexOf(e.doc.key)), {
...
function setDoc(t, e, n) {
	t = ra(t, X);
	const r = ra(t.firestore, da), o = __PRIVATE_applyFirestoreDataConverter(t.converter, e, n);
	return executeWrite(r, [__PRIVATE_parseSetData(la(r), "setDoc", t._key, o, null !== t.converter, n).toMutation(t._key, Precondition.none())]);
}
function updateDoc(t, e, n, ...r) {
	t = ra(t, X);
	const o = ra(t.firestore, da), i = la(o);
	let a;
	a = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", t._key, e, n, r) : __PRIVATE_parseUpdateData(i, "updateDoc", t._key, e);
...
*/ function executeWrite(t, e) {
	return __PRIVATE_firestoreClientWrite(oa(t), e);
}
/**
...
*/ function __PRIVATE_convertToDocSnapshot(t, e, n) {
	...
	return new DocumentSnapshot(t, new ua(t), e._key, r, new SnapshotMetadata(n.hasPendingWrites, n.fromCache), e.converter);
}
/**
* @license
* Copyright 2021 Google LLC
...
//#endregion
export { updateDoc as a, getFirestore as c, setDoc as i, getDocs as n, collection as o, onSnapshot as r, doc as s, getDoc as t };
