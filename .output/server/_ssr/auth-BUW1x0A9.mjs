...
import { c as initializeApp, n as isSupported, t as getAnalytics } from "../_libs/@firebase/analytics+[...].mjs";
import { i as signOut, n as onAuthStateChanged, r as signInAnonymously, t as getAuth } from "../_libs/firebase__auth.mjs";
import "../_libs/firebase.mjs";
import { c as getFirestore, i as setDoc, s as doc, t as getDoc } from "../_libs/@firebase/firestore+[...].mjs";
import { n as getStorage } from "../_libs/firebase__storage.mjs";
import { t as getFunctions } from "../_libs/firebase__functions.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-BUW1x0A9.js
...
if (typeof window !== "undefined") isSupported().then((supported) => {
...
var ROLE_META = {
	...
	vendor: {
		name: "Lavaant Vendor",
		tagline: "For suppliers & distributors",
		home: "/vendor"
	},
	crm: {
		name: "Lavaant CRM",
		tagline: "For construction sales pros",
		home: "/crm"
	}
};
var usd = (n) => Number(n || 0).toLocaleString("en-US", {
	style: "currency",
	currency: "USD",
	maximumFractionDigits: 0
});
var usdCents = (n) => Number(n || 0).toLocaleString("en-US", {
	style: "currency",
	currency: "USD"
});
...
var shipToBreakdown = [
	{
		location: "Northgate — Gate 4",
		orders: 41,
		spend: 152400
	},
	{
		location: "Harborview — Dock 1",
		orders: 28,
		spend: 131900
	},
	{
		location: "Yard B — Lay-Down",
		orders: 19,
		spend: 74600
	},
	{
...
var STORAGE_KEY = "lavaant.session";
...
function AuthProvider({ children }) {
	...
	const signIn = (0, import_react.useCallback)((role) => {
	...
	const signOut$1 = (0, import_react.useCallback)(() => {
		setUser(null);
		try {
...
//#endregion
export { vendorSalesTrend as S, spendByPerson as _, db as a, usdCents as b, initialCatalog as c, initialOrders as d, initialPlannerStops as f, spendByJob as g, shipToBreakdown as h, budgetVsActual as i, initialCrmCustomers as l, initialVendorInbox as m, DEMO_USERS as n, forecast as o, initialVendorCustomers as p, ROLE_META as r, functions as s, AuthProvider as t, initialInventoryItems as u, storage as v, useAuth as x, usd as y };
