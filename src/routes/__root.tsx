  ...
  head: () => ({
    meta: [
      ...
      { title: "Lavaant — Construction Inventory, Purchasing & Sales Platform" },
      {
        name: "description",
        content:
          "Lavaant turns stagnant construction inventory into trackable digital assets: inventory, vendor, and CRM portals in one platform.",
      },
      { name: "author", content: "Lavaant" },
