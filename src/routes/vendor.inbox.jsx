...
import { usd, initialVendorInbox } from "@/lib/mock-firebase";
import { useFirestoreCollection, updateOrderStatus } from "@/lib/firebase-service";
...
const FILTERS = ["All", "Submitted", "Acknowledged", "Shipped", "Received"];

function VendorInbox() {
  const { data: vendorInbox } = useFirestoreCollection("vendorInbox", initialVendorInbox);
  const [filter, setFilter] = useState("All");
  const [selectedId, setSelectedId] = useState(vendorInbox[0]?.id || "vo_01");
