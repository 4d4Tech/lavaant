...
import { plannerStops, type PlannerStop } from "@/lib/mock-firebase";
...
const TYPE_TONE: Record<PlannerStop["type"], string> = {
...
function DailyPlanner() {
  const [stops, setStops] = useState<PlannerStop[]>(plannerStops);
  ...
  return (
    <AppShell
      role="crm"
      title="Daily planner"
      subtitle="Thursday, July 30 — built for windshield time"
    >
