...
import { catalog, usdCents } from "@/lib/mock-firebase";
...
function Catalog() {
  // Firebase Storage: getDownloadURL(ref(storage, path))
  const openDoc = (label: string, path: string) =>
    toast.info(`${label} would open from Firebase Storage`, { description: path });
