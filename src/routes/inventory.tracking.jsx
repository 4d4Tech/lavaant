...
const TABS = ["By item", "By person", "By ship-to", "All orders"];
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard label="Purchase orders" value={String(orders.length || 125)} hint="Year to date" />
        <StatCard label="Avg. PO value" value={usd(totalSpend / (orders.length || 125))} />
              ...
              <tbody>
                {orders.map((o) => (
                  <tr key={o.id} className="hover:bg-muted/50">
                    ...
                    <Td>{o.requestedBy || o.contact}</Td>
                    <Td className="text-muted-foreground">{o.shipTo || "Yard B"}</Td>
                    <Td className="text-muted-foreground">{o.placedAt || o.received}</Td>
